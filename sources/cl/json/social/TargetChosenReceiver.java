...
public class TargetChosenReceiver extends BroadcastReceiver {
    ...
    public static IntentSender getSharingSenderIntent(ReactContext reactContext) {
        Class<TargetChosenReceiver> cls = TargetChosenReceiver.class;
        synchronized (LOCK) {
            if (sTargetChosenReceiveAction == null) {
                sTargetChosenReceiveAction = reactContext.getPackageName() + "/" + cls.getName() + "_ACTION";
            }
        ...
        intent.setClass(reactContext.getApplicationContext(), cls);
