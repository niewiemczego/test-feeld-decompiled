...
public final class Handshake {
    ...
    public final TlsVersion m2630deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m2625deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m2628deprecated_peerCertificates() {
    ...
    public final Principal m2629deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m2626deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m2627deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder append = new StringBuilder().append("Handshake{tlsVersion=").append(this.tlsVersion).append(" cipherSuite=").append(this.cipherSuite).append(" peerCertificates=").append(((List) arrayList).toString()).append(" localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake m2631deprecated_get(SSLSession sSLSession) throws IOException {
