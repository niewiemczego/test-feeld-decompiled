...
public final class Http2Stream {
    ...
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0059, code lost:
            if (r10.this$0.getSink$okhttp().finished != false) goto L_0x00bf;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x0065, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x0069;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x006c, code lost:
            if (r10.trailers == null) goto L_0x0070;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x00a4, code lost:
            if (r10.sendBuffer.size() <= 0) goto L_0x00bf;
         */
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x0038:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                boolean r1 = r10.getClosed()     // Catch:{ all -> 0x00da }
                if (r1 == 0) goto L_0x0043
                monitor-exit(r0)
                return
            L_0x0043:
                okhttp3.internal.http2.ErrorCode r1 = r0.getErrorCode$okhttp()     // Catch:{ all -> 0x00da }
                r2 = 0
                r3 = 1
            ...
            L_0x00bf:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                r10.setClosed(r3)     // Catch:{ all -> 0x00d7 }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00d7 }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Connection r0 = r0.getConnection()
                r0.flush()
    ...
    public final void receiveHeaders(okhttp3.Headers r3, boolean r4) {
        ...
        L_0x003b:
            monitor-enter(r2)
            boolean r0 = r2.hasResponseHeaders     // Catch:{ all -> 0x0075 }
            r1 = 1
            if (r0 == 0) goto L_0x004c
            if (r4 != 0) goto L_0x0044
            goto L_0x004c
        L_0x0044:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.getSource$okhttp()     // Catch:{ all -> 0x0075 }
            r0.setTrailers(r3)     // Catch:{ all -> 0x0075 }
            goto L_0x0055
        L_0x004c:
            r2.hasResponseHeaders = r1     // Catch:{ all -> 0x0075 }
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x0075 }
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x0075 }
            r0.add(r3)     // Catch:{ all -> 0x0075 }
        L_0x0055:
            if (r4 == 0) goto L_0x005e
            okhttp3.internal.http2.Http2Stream$FramingSource r3 = r2.getSource$okhttp()     // Catch:{ all -> 0x0075 }
            r3.setFinished$okhttp(r1)     // Catch:{ all -> 0x0075 }
        L_0x005e:
            boolean r3 = r2.isOpen()     // Catch:{ all -> 0x0075 }
            r4 = r2
            java.lang.Object r4 = (java.lang.Object) r4     // Catch:{ all -> 0x0075 }
