...
public final class Relay {
    ...
    public final class RelaySource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:50:0x0127, code lost:
            if (r2.getBuffer().size() <= r2.getBufferMaxSize()) goto L_0x013d;
         */
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0013:
                ...
                monitor-enter(r8)
            L_0x0018:
                long r6 = r8.getUpstreamPos()     // Catch:{ all -> 0x0172 }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                int r0 = (r9 > r6 ? 1 : (r9 == r6 ? 0 : -1))
                r6 = 2
                r9 = -1
                if (r0 == 0) goto L_0x005b
                long r11 = r8.getUpstreamPos()     // Catch:{ all -> 0x0172 }
                okio.Buffer r0 = r8.getBuffer()     // Catch:{ all -> 0x0172 }
                long r13 = r0.size()     // Catch:{ all -> 0x0172 }
                long r11 = r11 - r13
                long r13 = r1.sourcePos     // Catch:{ all -> 0x0172 }
            ...
            L_0x003a:
                ...
                long r9 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                long r6 = r6 - r9
                long r9 = java.lang.Math.min(r2, r6)     // Catch:{ all -> 0x0172 }
                okio.Buffer r2 = r8.getBuffer()     // Catch:{ all -> 0x0172 }
                long r3 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                long r6 = r3 - r11
                r3 = r20
                r4 = r6
                r6 = r9
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x0172 }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                long r2 = r2 + r9
                r1.sourcePos = r2     // Catch:{ all -> 0x0172 }
                monitor-exit(r8)
                return r9
            L_0x005b:
                boolean r0 = r8.getComplete()     // Catch:{ all -> 0x0172 }
                if (r0 == 0) goto L_0x0063
                monitor-exit(r8)
                return r9
            L_0x0063:
                java.lang.Thread r0 = r8.getUpstreamReader()     // Catch:{ all -> 0x0172 }
                if (r0 == 0) goto L_0x006f
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0172 }
                r0.waitUntilNotified(r8)     // Catch:{ all -> 0x0172 }
                goto L_0x0018
            L_0x006f:
                java.lang.Thread r0 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0172 }
                r8.setUpstreamReader(r0)     // Catch:{ all -> 0x0172 }
            L_0x0076:
                monitor-exit(r8)
                r11 = 32
            ...
            L_0x009c:
                r8 = 0
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                okio.Source r0 = r0.getUpstream()     // Catch:{ all -> 0x015e }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x015e }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r6 = r1.this$0     // Catch:{ all -> 0x015e }
                long r6 = r6.getBufferMaxSize()     // Catch:{ all -> 0x015e }
                long r14 = r0.read(r4, r6)     // Catch:{ all -> 0x015e }
                int r0 = (r14 > r9 ? 1 : (r14 == r9 ? 0 : -1))
                if (r0 != 0) goto L_0x00d6
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x015e }
                r0.commit(r2)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r8)     // Catch:{ all -> 0x00d3 }
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x00d3 }
            ...
            L_0x00d3:
                ...
                throw r0
            L_0x00d6:
                long r9 = java.lang.Math.min(r14, r2)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                okio.Buffer r2 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x015e }
                r6 = 0
                r3 = r20
                r4 = r6
                r6 = r9
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x015e }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x015e }
                long r2 = r2 + r9
                r1.sourcePos = r2     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.FileOperator r13 = r1.fileOperator     // Catch:{ all -> 0x015e }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r13)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                long r2 = r0.getUpstreamPos()     // Catch:{ all -> 0x015e }
                long r2 = r2 + r11
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                okio.Buffer r0 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x015e }
                okio.Buffer r16 = r0.clone()     // Catch:{ all -> 0x015e }
                r4 = r14
                r14 = r2
                r17 = r4
                r13.write(r14, r16, r17)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r2 = r1.this$0     // Catch:{ all -> 0x015e }
                monitor-enter(r2)     // Catch:{ all -> 0x015e }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x015b }
                okio.Buffer r3 = r2.getUpstreamBuffer()     // Catch:{ all -> 0x015b }
                r0.write((okio.Buffer) r3, (long) r4)     // Catch:{ all -> 0x015b }
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x015b }
                long r6 = r0.size()     // Catch:{ all -> 0x015b }
                long r11 = r2.getBufferMaxSize()     // Catch:{ all -> 0x015b }
                int r0 = (r6 > r11 ? 1 : (r6 == r11 ? 0 : -1))
                if (r0 <= 0) goto L_0x013d
                okio.Buffer r0 = r2.getBuffer()     // Catch:{ all -> 0x015b }
                okio.Buffer r3 = r2.getBuffer()     // Catch:{ all -> 0x015b }
                long r6 = r3.size()     // Catch:{ all -> 0x015b }
                long r11 = r2.getBufferMaxSize()     // Catch:{ all -> 0x015b }
                long r6 = r6 - r11
                r0.skip(r6)     // Catch:{ all -> 0x015b }
            L_0x013d:
                long r6 = r2.getUpstreamPos()     // Catch:{ all -> 0x015b }
                long r6 = r6 + r4
                r2.setUpstreamPos(r6)     // Catch:{ all -> 0x015b }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x015b }
                monitor-exit(r2)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r8)     // Catch:{ all -> 0x0158 }
                r0 = r2
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x0158 }
                r0.notifyAll()     // Catch:{ all -> 0x0158 }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0158 }
                monitor-exit(r2)
                return r9
            L_0x0158:
                r0 = move-exception
            ...
            L_0x015e:
                ...
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r8)     // Catch:{ all -> 0x016f }
                r3 = r2
                java.lang.Object r3 = (java.lang.Object) r3     // Catch:{ all -> 0x016f }
                r3.notifyAll()     // Catch:{ all -> 0x016f }
                kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x016f }
                monitor-exit(r2)
                throw r0
            L_0x016f:
                r0 = move-exception
