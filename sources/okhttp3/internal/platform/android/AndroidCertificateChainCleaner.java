...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        if (array != null) {
            try {
                List<X509Certificate> checkServerTrusted = this.x509TrustManagerExtensions.checkServerTrusted((X509Certificate[]) array, CipherStorageKeystoreRsaEcb.ALGORITHM_RSA, str);
    ...
    public static final class Companion {
        ...
        public final AndroidCertificateChainCleaner buildIfSupported(X509TrustManager x509TrustManager) {
            ...
            try {
                ...
                X509TrustManagerExtensions x509TrustManagerExtensions2 = null;
