...
public final class LoggingEventListener extends EventListener {
    ...
    public void proxySelectStart(Call call, HttpUrl httpUrl) {
        ...
        logWithTime(Intrinsics.stringPlus("proxySelectStart: ", httpUrl));
    }
    ...
    public void proxySelectEnd(Call call, HttpUrl httpUrl, List<? extends Proxy> list) {
        ...
        logWithTime(Intrinsics.stringPlus("proxySelectEnd: ", list));
    }

    public void dnsStart(Call call, String str) {
        Intrinsics.checkNotNullParameter(call, NotificationCompat.CATEGORY_CALL);
        Intrinsics.checkNotNullParameter(str, "domainName");
        logWithTime(Intrinsics.stringPlus("dnsStart: ", str));
    }
    ...
    public void dnsEnd(Call call, String str, List<? extends InetAddress> list) {
        ...
        logWithTime(Intrinsics.stringPlus("dnsEnd: ", list));
    }
    ...
    public void requestFailed(Call call, IOException iOException) {
        Intrinsics.checkNotNullParameter(call, NotificationCompat.CATEGORY_CALL);
        Intrinsics.checkNotNullParameter(iOException, "ioe");
        logWithTime(Intrinsics.stringPlus("requestFailed: ", iOException));
    }
    ...
    public void responseFailed(Call call, IOException iOException) {
        Intrinsics.checkNotNullParameter(call, NotificationCompat.CATEGORY_CALL);
        Intrinsics.checkNotNullParameter(iOException, "ioe");
        logWithTime(Intrinsics.stringPlus("responseFailed: ", iOException));
    }
    ...
    public void callFailed(Call call, IOException iOException) {
        Intrinsics.checkNotNullParameter(call, NotificationCompat.CATEGORY_CALL);
        Intrinsics.checkNotNullParameter(iOException, "ioe");
        logWithTime(Intrinsics.stringPlus("callFailed: ", iOException));
    }
    ...
    public void cacheConditionalHit(Call call, Response response) {
        ...
        logWithTime(Intrinsics.stringPlus("cacheConditionalHit: ", response));
    }
