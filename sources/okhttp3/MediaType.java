...
public final class MediaType {
    ...
    public final String parameter(String str) {
        ...
        while (true) {
            int i2 = i + 2;
            if (StringsKt.equals(this.parameterNamesAndValues[i], str, true)) {
    ...
    public final String m2659deprecated_type() {
        return this.type;
    }
    ...
    public final String m2658deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
            ...
            if (matcher.lookingAt()) {
                ...
                while (end < str.length()) {
                    ...
                    if (matcher2.lookingAt()) {
                        ...
                        throw new IllegalArgumentException(append.append(substring).append("\" for: \"").append(str).append(Typography.quote).toString().toString());
                    }
                }
        ...
        public final MediaType m2660deprecated_get(String str) {
        ...
        public final MediaType m2661deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
    }
