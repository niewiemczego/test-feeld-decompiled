...
public final class _UtilKt {
    ...
    public static final boolean arrayRangeEquals(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        Intrinsics.checkNotNullParameter(bArr, Constants.BRAZE_PUSH_CONTENT_KEY);
