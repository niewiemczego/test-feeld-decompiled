...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer writeTo(OutputStream outputStream, long j) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream, "out");
        _UtilKt.checkOffsetAndCount(this.size, 0, j);
        Segment segment = this.head;
        while (j > 0) {
            Intrinsics.checkNotNull(segment);
    ...
    public final byte m2722deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m2723deprecated_size() {
        return this.size;
    }
    ...
    public long readDecimalLong() throws java.io.EOFException {
        ...
        L_0x00bf:
            ...
            java.lang.String r3 = okio._UtilKt.toHexString((byte) r3)
            java.lang.StringBuilder r1 = r1.append(r3)
            java.lang.String r1 = r1.toString()
            r2.<init>(r1)
            throw r2
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (size() != 0) {
            ...
            throw new EOFException("size < " + i + ": " + size() + " (to read code point prefixed 0x" + _UtilKt.toHexString(b3) + ')');
        }
        throw new EOFException();
    }
                    ...
                    if (segment != null) {
                        ...
                        while (size2 < size4) {
                            ...
                            for (int i = (int) (j5 - j6); i < min; i++) {
                                if (bArr[i] == b && _BufferKt.rangeEquals(segment, i + 1, internalArray$okio, 1, size3)) {
                    ...
                    if (segment != null) {
                        ...
                        while (j3 < size6) {
                            ...
                            for (int i2 = (int) ((((long) segment.pos) + j2) - j3); i2 < min2; i2++) {
                                if (bArr2[i2] == b2) {
                                    if (_BufferKt.rangeEquals(segment, i2 + 1, internalArray$okio2, 1, size5)) {
