...
public final class _SegmentedByteStringKt {
    ...
    public static final byte commonInternalGet(SegmentedByteString segmentedByteString, int i) {
        int i2;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        _UtilKt.checkOffsetAndCount((long) segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length - 1], (long) i, 1);
        int segment = segment(segmentedByteString, i);
        if (segment == 0) {
            i2 = 0;
        } else {
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            int i6 = segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length + segment];
            int min = Math.min(i5, (segmentedByteString.getDirectory$okio()[segment] - i4) + i4) - i;
            if (!_UtilKt.arrayRangeEquals(segmentedByteString.getSegments$okio()[segment], i6 + (i - i4), bArr, i2, min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final void commonCopyInto(SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        ...
        long j = (long) i3;
        _UtilKt.checkOffsetAndCount((long) segmentedByteString.size(), (long) i, j);
        _UtilKt.checkOffsetAndCount((long) bArr.length, (long) i2, j);
        int i5 = i3 + i;
        int segment = segment(segmentedByteString, i);
        while (i < i5) {
            if (segment == 0) {
