...
public final class CipherSource implements Source {
    ...
    private final void refill() {
        while (this.buffer.size() == 0 && !this.f6final) {
    ...
    private final void update() {
        ...
        buffer3.setSize$okio(buffer3.size() + ((long) update));
