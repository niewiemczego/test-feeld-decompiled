...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    static String[] names = {ViewProps.POSITION, ViewHierarchyNode.JsonKeys.X, ViewHierarchyNode.JsonKeys.Y, "width", "height", "pathRotate"};
        ...
        for (String next : hashMap.keySet()) {
            ...
            switch (next.hashCode()) {
                ...
                case 37232917:
                    ...
                    break;
                case 92909918:
                    if (next.equals(ViewHierarchyNode.JsonKeys.ALPHA)) {
                        c = CharUtils.CR;
                        break;
                    }
                    break;
