...
public class MotionController {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        for (String next8 : this.mEndMotionPath.attributes.keySet()) {
            if (this.mStartMotionPath.attributes.containsKey(next8) && !hashSet2.contains("CUSTOM," + next8)) {
                hashSet4.add(next8);
            }
        }
        ...
        while (true) {
            ...
            if (iArr4[i12] < MotionPaths.names.length) {
        ...
        while (true) {
            ...
            double[][] dArr5 = null;
            while (i15 < size) {
                if (motionPathsArr[i15].hasCustomData(str7)) {
                    if (dArr5 == null) {
                        int[] iArr5 = new int[2];
                        iArr5[c] = motionPathsArr[i15].getCustomDataCount(str7);
                        iArr5[0] = size;
                        dArr5 = (double[][]) Array.newInstance(Double.TYPE, iArr5);
                        dArr4 = new double[size];
                    }
                    dArr4[i16] = (double) motionPathsArr[i15].time;
                    motionPathsArr[i15].getCustomData(str7, dArr5[i16], 0);
                    i16++;
                }
                i15++;
                c = 1;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            iArr7[1] = 2;
            iArr7[0] = size;
            double[][] dArr7 = (double[][]) Array.newInstance(Double.TYPE, iArr7);
            for (int i17 = 0; i17 < size; i17++) {
                iArr6[i17] = motionPathsArr[i17].mPathMotionArc;
                dArr6[i17] = (double) motionPathsArr[i17].time;
                dArr7[i17][0] = (double) motionPathsArr[i17].x;
                dArr7[i17][1] = (double) motionPathsArr[i17].y;
            }
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        KeyCycleOscillator keyCycleOscillator4 = hashMap8 == null ? null : hashMap8.get(ViewProps.ROTATION);
        HashMap<String, KeyCycleOscillator> hashMap9 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator5 = hashMap9 == null ? null : hashMap9.get(ViewProps.SCALE_X);
        HashMap<String, KeyCycleOscillator> hashMap10 = this.mCycleMap;
        if (hashMap10 != null) {
            keyCycleOscillator = hashMap10.get(ViewProps.SCALE_Y);
        }
