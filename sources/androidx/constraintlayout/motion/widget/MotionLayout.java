...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            Log.v(MotionLayout.TAG, str + append5.append(str6).toString() + " ---  " + constraintWidget);
        }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = "_";
                StringBuilder append = new StringBuilder().append((("" + (constraintWidget.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : str4)) + (constraintWidget.mBottom.mTarget != null ? "B" : str4)) + (constraintWidget.mLeft.mTarget != null ? "L" : str4));
                if (constraintWidget.mRight.mTarget != null) {
                    str4 = "R";
                }
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + " " + constraintWidget + " " + sb);
            }
