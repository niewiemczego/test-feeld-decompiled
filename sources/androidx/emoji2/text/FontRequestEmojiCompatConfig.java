    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void createMetadata() {
            /*
                ...
                monitor-enter(r0)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r7.mCallback     // Catch:{ all -> 0x00aa }
                if (r1 != 0) goto L_0x0009
                monitor-exit(r0)     // Catch:{ all -> 0x00aa }
                return
            L_0x0009:
                monitor-exit(r0)     // Catch:{ all -> 0x00aa }
                androidx.core.provider.FontsContractCompat$FontInfo r0 = r7.retrieveFontInfo()     // Catch:{ all -> 0x0097 }
                int r1 = r0.getResultCode()     // Catch:{ all -> 0x0097 }
                r2 = 2
                if (r1 != r2) goto L_0x0034
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0097 }
            ...
            L_0x0034:
                ...
                androidx.core.os.TraceCompat.endSection()     // Catch:{ all -> 0x0097 }
                java.lang.Object r1 = r7.mLock     // Catch:{ all -> 0x0097 }
            ...
            L_0x0073:
                ...
                throw r0     // Catch:{ all -> 0x0097 }
            L_0x0078:
                java.lang.RuntimeException r0 = new java.lang.RuntimeException     // Catch:{ all -> 0x0097 }
                ...
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x0097 }
                java.lang.StringBuilder r1 = r2.append(r1)     // Catch:{ all -> 0x0097 }
                java.lang.String r2 = ")"
                java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x0097 }
            ...
            L_0x0097:
                ...
                monitor-enter(r1)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r2 = r7.mCallback     // Catch:{ all -> 0x00a7 }
                if (r2 == 0) goto L_0x00a2
                r2.onFailed(r0)     // Catch:{ all -> 0x00a7 }
            L_0x00a2:
