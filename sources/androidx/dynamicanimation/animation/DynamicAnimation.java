...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    public static final ViewProperty ALPHA = new ViewProperty(ViewHierarchyNode.JsonKeys.ALPHA) {
    ...
    public static final ViewProperty ROTATION = new ViewProperty(ViewProps.ROTATION) {
        public void setValue(View view, float f) {
            view.setRotation(f);
        }
    ...
    public static final ViewProperty SCALE_X = new ViewProperty(ViewProps.SCALE_X) {
        public void setValue(View view, float f) {
            view.setScaleX(f);
        }
    ...
    public static final ViewProperty SCALE_Y = new ViewProperty(ViewProps.SCALE_Y) {
        public void setValue(View view, float f) {
            view.setScaleY(f);
        }
    ...
    public static final ViewProperty X = new ViewProperty(ViewHierarchyNode.JsonKeys.X) {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    public static final ViewProperty Y = new ViewProperty(ViewHierarchyNode.JsonKeys.Y) {
        public void setValue(View view, float f) {
            view.setY(f);
        }
