...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        if (sCanApplyOverrideConfiguration && (context instanceof ContextThemeWrapper)) {
            try {
                ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration((ContextThemeWrapper) context, createOverrideConfigurationForDayNight(context, mapNightMode, (Configuration) null, false));
                return context;
        ...
        if (context instanceof androidx.appcompat.view.ContextThemeWrapper) {
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) context).applyOverrideConfiguration(createOverrideConfigurationForDayNight(context, mapNightMode, (Configuration) null, false));
                return context;
        ...
        Configuration createOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(context, mapNightMode, configuration, true);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0083, code lost:
        if (((org.xmlpull.v1.XmlPullParser) r15).getDepth() > 1) goto L_0x008d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private boolean updateForNightMode(int i, boolean z) {
        boolean z2 = false;
        Configuration createOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(this.mContext, i, (Configuration) null, false);
        ...
        if (z2 || i2 == i3) {
            ...
            updateResourcesConfigurationForNightMode(i3, isActivityManifestHandlingUiMode, (Configuration) null);
        }
        if (z3) {
