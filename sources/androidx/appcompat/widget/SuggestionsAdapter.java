...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r7) {
        /*
            ...
            r2 = 0
            java.lang.String r3 = r7.getScheme()     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r4 = "android.resource"
            boolean r3 = r4.equals(r3)     // Catch:{ FileNotFoundException -> 0x008d }
            if (r3 == 0) goto L_0x002f
            android.graphics.drawable.Drawable r7 = r6.getDrawableFromResourceUri(r7)     // Catch:{ NotFoundException -> 0x0016 }
            return r7
        L_0x0016:
            java.io.FileNotFoundException r0 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x008d }
            r3.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r4 = "Resource does not exist: "
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r3 = r3.append(r7)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r3 = r3.toString()     // Catch:{ FileNotFoundException -> 0x008d }
            r0.<init>(r3)     // Catch:{ FileNotFoundException -> 0x008d }
            throw r0     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x002f:
            android.content.Context r3 = r6.mProviderContext     // Catch:{ FileNotFoundException -> 0x008d }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ FileNotFoundException -> 0x008d }
            java.io.InputStream r3 = r3.openInputStream(r7)     // Catch:{ FileNotFoundException -> 0x008d }
            if (r3 == 0) goto L_0x0074
            android.graphics.drawable.Drawable r4 = android.graphics.drawable.Drawable.createFromStream(r3, r2)     // Catch:{ all -> 0x0059 }
        ...
        L_0x0043:
            ...
            r5.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = r5.append(r0)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r0 = r0.append(r7)     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.String r0 = r0.toString()     // Catch:{ FileNotFoundException -> 0x008d }
            android.util.Log.e(r1, r0, r3)     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0058:
            return r4
        L_0x0059:
            r4 = move-exception
        ...
        L_0x005e:
            ...
            android.util.Log.e(r1, r0, r3)     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0073:
            throw r4     // Catch:{ FileNotFoundException -> 0x008d }
        L_0x0074:
            java.io.FileNotFoundException r0 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x008d }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x008d }
            r3.<init>()     // Catch:{ FileNotFoundException -> 0x008d }
