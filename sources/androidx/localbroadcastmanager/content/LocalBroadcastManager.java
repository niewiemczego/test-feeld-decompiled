...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r22) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0183 }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x0183 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x0183 }
            java.lang.String r11 = r0.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x0183 }
            android.net.Uri r12 = r22.getData()     // Catch:{ all -> 0x0183 }
            java.lang.String r13 = r22.getScheme()     // Catch:{ all -> 0x0183 }
            java.util.Set r14 = r22.getCategories()     // Catch:{ all -> 0x0183 }
            int r3 = r22.getFlags()     // Catch:{ all -> 0x0183 }
            r3 = r3 & 8
        ...
        L_0x002e:
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r4 = r4.append(r11)     // Catch:{ all -> 0x0183 }
            java.lang.String r5 = " scheme "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r4 = r4.append(r13)     // Catch:{ all -> 0x0183 }
            java.lang.String r5 = " of intent "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r4 = r4.append(r0)     // Catch:{ all -> 0x0183 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0183 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0183 }
        L_0x005c:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x0183 }
            java.lang.String r4 = r22.getAction()     // Catch:{ all -> 0x0183 }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x0183 }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x0183 }
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r4 = r4.append(r8)     // Catch:{ all -> 0x0183 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0183 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0183 }
        L_0x0085:
            r3 = 0
            ...
            r6 = 0
        L_0x0088:
            int r3 = r8.size()     // Catch:{ all -> 0x0183 }
            if (r6 >= r3) goto L_0x0150
            java.lang.Object r3 = r8.get(r6)     // Catch:{ all -> 0x0183 }
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x0183 }
            if (r16 == 0) goto L_0x00b1
            java.lang.String r3 = "LocalBroadcastManager"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0183 }
            r4.<init>()     // Catch:{ all -> 0x0183 }
            java.lang.String r9 = "Matching against filter "
            java.lang.StringBuilder r4 = r4.append(r9)     // Catch:{ all -> 0x0183 }
            android.content.IntentFilter r9 = r5.filter     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r4 = r4.append(r9)     // Catch:{ all -> 0x0183 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0183 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0183 }
        L_0x00b1:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x0183 }
        ...
        L_0x00be:
            ...
            goto L_0x0145
        L_0x00ca:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x0183 }
            ...
            r20 = r11
            r11 = 1
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0183 }
            ...
            java.lang.StringBuilder r5 = r5.append(r6)     // Catch:{ all -> 0x0183 }
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x0183 }
            java.lang.StringBuilder r3 = r5.append(r3)     // Catch:{ all -> 0x0183 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0183 }
            android.util.Log.v(r4, r3)     // Catch:{ all -> 0x0183 }
        L_0x0102:
        ...
        L_0x010a:
            r7 = r10
        L_0x010b:
            r7.add(r15)     // Catch:{ all -> 0x0183 }
            r15.broadcasting = r11     // Catch:{ all -> 0x0183 }
            goto L_0x0146
        L_0x0111:
        ...
        L_0x0150:
            ...
            r3 = 0
        L_0x0155:
            int r4 = r10.size()     // Catch:{ all -> 0x0183 }
            if (r3 >= r4) goto L_0x0167
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x0183 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0183 }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x0183 }
            int r3 = r3 + 1
            goto L_0x0155
        L_0x0167:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0183 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0183 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0183 }
            r3.add(r4)     // Catch:{ all -> 0x0183 }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0183 }
            boolean r0 = r0.hasMessages(r11)     // Catch:{ all -> 0x0183 }
            if (r0 != 0) goto L_0x017e
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0183 }
            r0.sendEmptyMessage(r11)     // Catch:{ all -> 0x0183 }
        L_0x017e:
