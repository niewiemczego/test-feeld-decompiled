...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(String str) {
            ...
            allowAction((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda2(str));
            return this;
        }
        ...
        public Builder allowDataWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            allowData(new IntentSanitizer$Builder$$ExternalSyntheticLambda7(str));
            return this;
        }
        ...
        public Builder allowType(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda2(str));
        }
        ...
        public Builder allowCategory(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda2(str));
        }
        ...
        public Builder allowPackage(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage((Predicate<String>) new IntentSanitizer$Builder$$ExternalSyntheticLambda2(str));
        }
        ...
        public Builder allowComponent(ComponentName componentName) {
            ...
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda9(componentName));
        }
        ...
        public Builder allowComponentWithPackage(String str) {
            Preconditions.checkNotNull(str);
            return allowComponent((Predicate<ComponentName>) new IntentSanitizer$Builder$$ExternalSyntheticLambda6(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new IntentSanitizer$Builder$$ExternalSyntheticLambda1(str));
        }
        ...
        public Builder allowExtra(String str, Class<?> cls) {
            return allowExtra(str, cls, new IntentSanitizer$Builder$$ExternalSyntheticLambda10());
        }
        ...
        public <T> Builder allowExtra(String str, Class<T> cls, Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, (Predicate<Object>) new IntentSanitizer$Builder$$ExternalSyntheticLambda5(cls, predicate));
        }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                new IntentSanitizer$Builder$$ExternalSyntheticLambda0
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0012: CONSTRUCTOR  (r0v5 ? I:androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda0) =  call: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda0.<init>():void type: CONSTRUCTOR in method: androidx.core.content.IntentSanitizer.Builder.allowExtra(java.lang.String, androidx.core.util.Predicate):androidx.core.content.IntentSanitizer$Builder, dex: classes.dex
                ...
                /*
                    ...
                    androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda0 r0 = new androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda0
                    r0.<init>()
                L_0x0015:
            ...
            public Builder allowExtraStreamUriWithAuthority(String str) {
                Preconditions.checkNotNull(str);
                allowExtra("android.intent.extra.STREAM", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda3(str));
                return this;
            }
            ...
            public Builder allowExtraOutput(String str) {
                allowExtra("output", Uri.class, new IntentSanitizer$Builder$$ExternalSyntheticLambda8(str));
                return this;
            }
