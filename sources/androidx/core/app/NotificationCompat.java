...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x01b3:
                ...
                androidx.core.app.NotificationCompat.Style.Api16Impl.setTextViewTextSize(r7, r0, r9, r15)
            L_0x01c7:
                ...
                r6 = 0
                r1 = r7
                androidx.core.app.NotificationCompat.Style.Api16Impl.setViewPadding(r1, r2, r3, r4, r5, r6)
            L_0x01d1:
                ...
                androidx.core.app.NotificationCompat.Style.Api24Impl.setChronometerCountDown(r7, r14, r15)
                goto L_0x0234
            L_0x0220:
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                Api16Impl.setBuilder(messagingStyle, notificationBuilderWithBuilderAccessor.getBuilder());
                return;
            }
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                Api16Impl.bigText(Api16Impl.setBigContentTitle(Api16Impl.createBigTextStyle(notificationBuilderWithBuilderAccessor.getBuilder()), (CharSequence) null), spannableStringBuilder);
            }
        }
        ...
        public static final class Message {
            ...
            public android.app.Notification.MessagingStyle.Message toAndroidMessage() {
                /*
                    r5 = this;
                    androidx.core.app.Person r0 = r5.getPerson()
                    int r1 = android.os.Build.VERSION.SDK_INT
                    r2 = 0
                    r3 = 28
                ...
                L_0x001a:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat.MessagingStyle.Message.Api28Impl.createMessage(r1, r3, r2)
                    goto L_0x0032
                L_0x001f:
                    java.lang.CharSequence r1 = r5.getText()
                    long r3 = r5.getTimestamp()
                ...
                L_0x002e:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat.MessagingStyle.Message.Api24Impl.createMessage(r1, r3, r2)
                L_0x0032:
                    java.lang.String r1 = r5.getDataMimeType()
                    if (r1 == 0) goto L_0x0043
                    java.lang.String r1 = r5.getDataMimeType()
                    android.net.Uri r2 = r5.getDataUri()
    ...
    public static class CallStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                if (callStyle != null) {
                    ...
                    Api16Impl.setBuilder(callStyle, notificationBuilderWithBuilderAccessor.getBuilder());
                    Integer num = this.mAnswerButtonColor;
                    if (num != null) {
            ...
            if (Build.VERSION.SDK_INT >= 20) {
                ...
                for (Action actionFromActionCompat : actionsListWithSystemActions) {
                    Api20Impl.addAction(builder, getActionFromActionCompat(actionFromActionCompat));
                }
            }
            if (Build.VERSION.SDK_INT >= 21) {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                builder = Api23Impl.createActionBuilder(icon, action.getTitle(), action.getActionIntent());
            } else {
                IconCompat iconCompat2 = action.getIconCompat();
                builder = Api20Impl.createActionBuilder((iconCompat2 == null || iconCompat2.getType() != 2) ? 0 : iconCompat2.getResId(), action.getTitle(), action.getActionIntent());
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            z2 = Api31Impl.isAuthenticationRequired(action);
        }
        boolean z5 = z2;
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
        }
        ...
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z3, i3, z4, isContextual, z5);
    }
