...
public class ActivityCompat extends ContextCompat {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            ...
            while (i2 < strArr.length) {
                if (!TextUtils.isEmpty(strArr[i2])) {
                    if (!BuildCompat.isAtLeastT() && TextUtils.equals(strArr[i2], RuntimePermissionStateHandler.NOTIFICATION_PERMISSION)) {
    ...
    public static boolean shouldShowRequestPermissionRationale(Activity activity, String str) {
        if (!BuildCompat.isAtLeastT() && TextUtils.equals(RuntimePermissionStateHandler.NOTIFICATION_PERMISSION, str)) {
            return false;
        }
