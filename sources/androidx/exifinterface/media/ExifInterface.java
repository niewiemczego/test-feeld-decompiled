...
public class ExifInterface {
    ...
    private static class ExifAttribute {
        ...
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            ...
            L_0x0191:
                ...
                android.util.Log.w(r1, r4, r11)     // Catch:{ all -> 0x01a1 }
    ...
    public ExifInterface(java.io.FileDescriptor r6) throws java.io.IOException {
        /*
            ...
            java.io.FileDescriptor r6 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r6)     // Catch:{ Exception -> 0x0032 }
            r1 = 1
            goto L_0x003d
        L_0x0032:
            r6 = move-exception
        ...
        L_0x003d:
            ...
            r2.<init>(r6)     // Catch:{ all -> 0x0050 }
            r5.loadAttributes(r2)     // Catch:{ all -> 0x004e }
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x00c1:
            ...
            goto L_0x012b
        L_0x0100:
            double r8 = java.lang.Double.parseDouble(r2)     // Catch:{ NumberFormatException -> 0x010e }
            androidx.exifinterface.media.ExifInterface$Rational r10 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ NumberFormatException -> 0x010e }
            r10.<init>(r8)     // Catch:{ NumberFormatException -> 0x010e }
            java.lang.String r2 = r10.toString()     // Catch:{ NumberFormatException -> 0x010e }
            goto L_0x012b
        L_0x010e:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>()
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x002e:
            ...
            java.io.File r2 = java.io.File.createTempFile(r2, r3)     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            java.lang.String r3 = r14.mFilename     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            r4 = 0
            r6 = 21
            if (r3 == 0) goto L_0x0050
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            goto L_0x0064
        L_0x0050:
            int r3 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            if (r3 < r6) goto L_0x0063
            java.io.FileDescriptor r3 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r3, r4, r7)     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x017c, all -> 0x0179 }
            goto L_0x0064
        L_0x0063:
            r3 = r1
        L_0x0064:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0175, all -> 0x0171 }
            r7.<init>(r2)     // Catch:{ Exception -> 0x0175, all -> 0x0171 }
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r3, r7)     // Catch:{ Exception -> 0x016f, all -> 0x016d }
            ...
            java.lang.String r8 = r14.mFilename     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            if (r8 == 0) goto L_0x0084
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            java.lang.String r9 = r14.mFilename     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
        ...
        L_0x0084:
            ...
            java.io.FileDescriptor r8 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            int r9 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r8, r4, r9)     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            java.io.FileDescriptor r9 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            r8.<init>(r9)     // Catch:{ Exception -> 0x00eb, all -> 0x00f0 }
            goto L_0x0098
        L_0x0097:
            r8 = r1
        L_0x0098:
            ...
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00d6 }
            r12 = 4
            if (r11 != r12) goto L_0x00ab
            r14.saveJpegAttributes(r9, r10)     // Catch:{ Exception -> 0x00d6 }
            goto L_0x00ca
        L_0x00ab:
            r12 = 13
            if (r11 != r12) goto L_0x00b3
            r14.savePngAttributes(r9, r10)     // Catch:{ Exception -> 0x00d6 }
            goto L_0x00ca
        L_0x00b3:
            r12 = 14
            if (r11 != r12) goto L_0x00bb
            r14.saveWebpAttributes(r9, r10)     // Catch:{ Exception -> 0x00d6 }
            goto L_0x00ca
        L_0x00bb:
            r12 = 3
        ...
        L_0x00c0:
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream r11 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataOutputStream     // Catch:{ Exception -> 0x00d6 }
            java.nio.ByteOrder r12 = java.nio.ByteOrder.BIG_ENDIAN     // Catch:{ Exception -> 0x00d6 }
            r11.<init>(r10, r12)     // Catch:{ Exception -> 0x00d6 }
            r14.writeExifSegment(r11)     // Catch:{ Exception -> 0x00d6 }
        L_0x00ca:
        ...
        L_0x00f9:
            ...
            java.lang.String r1 = r14.mFilename     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            if (r1 != 0) goto L_0x0115
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            if (r1 < r6) goto L_0x011d
            java.io.FileDescriptor r1 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            int r6 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r4, r6)     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            r1.<init>(r4)     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            goto L_0x011c
        L_0x0115:
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            r1.<init>(r4)     // Catch:{ Exception -> 0x0130, all -> 0x012e }
        L_0x011c:
            r8 = r1
        L_0x011d:
            androidx.exifinterface.media.ExifInterfaceUtils.copy(r11, r8)     // Catch:{ Exception -> 0x0130, all -> 0x012e }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r11)     // Catch:{ all -> 0x015f }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r8)     // Catch:{ all -> 0x015f }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x015f }
            java.lang.String r1 = "Failed to save new file"
            r0.<init>(r1, r7)     // Catch:{ all -> 0x015f }
        ...
        L_0x0137:
            ...
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0154 }
            r4.<init>()     // Catch:{ all -> 0x0154 }
            java.lang.String r5 = "Failed to save new file. Original file is stored in "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0154 }
            java.lang.String r5 = r2.getAbsolutePath()     // Catch:{ all -> 0x0154 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0154 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0154 }
            r3.<init>(r4, r1)     // Catch:{ all -> 0x0154 }
        ...
        L_0x0157:
            r1 = r11
        L_0x0158:
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)     // Catch:{ all -> 0x015f }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r8)     // Catch:{ all -> 0x015f }
            throw r0     // Catch:{ all -> 0x015f }
        L_0x015f:
            r0 = move-exception
        ...
        L_0x017c:
            ...
            r7 = r1
        L_0x017e:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x0186 }
            java.lang.String r3 = "Failed to copy original file to temp file"
            r2.<init>(r3, r0)     // Catch:{ all -> 0x0186 }
    ...
    public byte[] getThumbnailBytes() {
        ...
        L_0x003a:
            ...
            java.io.FileDescriptor r1 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r1)     // Catch:{ Exception -> 0x00a7, all -> 0x00a4 }
            r3 = 0
            int r5 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x005a, all -> 0x0056 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r3, r5)     // Catch:{ Exception -> 0x005a, all -> 0x0056 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:60:0x018d A[LOOP:0: B:8:0x003a->B:60:0x018d, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:74:0x0197 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void getHeifAttributes(final androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r13) throws java.io.IOException {
        /*
            ...
            r2.<init>(r13)     // Catch:{ RuntimeException -> 0x0140 }
        ...
        L_0x0062:
            ...
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r7 = r12.mAttributes     // Catch:{ RuntimeException -> 0x0140 }
            r7 = r7[r5]     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r8 = "ImageWidth"
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ RuntimeException -> 0x0140 }
            java.nio.ByteOrder r10 = r12.mExifByteOrder     // Catch:{ RuntimeException -> 0x0140 }
        ...
        L_0x00a7:
            r8 = r7
        L_0x00a8:
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r9 = r12.mAttributes     // Catch:{ RuntimeException -> 0x0140 }
            r9 = r9[r5]     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r10 = "Orientation"
            java.nio.ByteOrder r11 = r12.mExifByteOrder     // Catch:{ RuntimeException -> 0x0140 }
        ...
        L_0x00b7:
            ...
            r13.seek(r8)     // Catch:{ RuntimeException -> 0x0140 }
            byte[] r8 = new byte[r7]     // Catch:{ RuntimeException -> 0x0140 }
            int r9 = r13.read(r8)     // Catch:{ RuntimeException -> 0x0140 }
            ...
            int r13 = r13.read(r7)     // Catch:{ RuntimeException -> 0x0140 }
            if (r13 != r3) goto L_0x00ea
            r12.mOffsetToExifData = r2     // Catch:{ RuntimeException -> 0x0140 }
            r12.readExifSegment(r7, r5)     // Catch:{ RuntimeException -> 0x0140 }
            goto L_0x010a
        L_0x00ea:
            java.io.IOException r13 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r0 = "Can't read exif"
            r13.<init>(r0)     // Catch:{ RuntimeException -> 0x0140 }
            throw r13     // Catch:{ RuntimeException -> 0x0140 }
        L_0x00f2:
            java.io.IOException r13 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0140 }
        ...
        L_0x0102:
            ...
            throw r13     // Catch:{ RuntimeException -> 0x0140 }
        L_0x010a:
            boolean r13 = DEBUG     // Catch:{ RuntimeException -> 0x0140 }
            if (r13 == 0) goto L_0x013a
            java.lang.String r13 = "ExifInterface"
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x0140 }
            r2.<init>()     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r3 = "Heif meta: "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.StringBuilder r2 = r2.append(r6)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r3 = "x"
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r2 = ", rotation "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.StringBuilder r0 = r0.append(r4)     // Catch:{ RuntimeException -> 0x0140 }
            java.lang.String r0 = r0.toString()     // Catch:{ RuntimeException -> 0x0140 }
            android.util.Log.d(r13, r0)     // Catch:{ RuntimeException -> 0x0140 }
        L_0x013a:
            r1.release()
            return
        L_0x013e:
            ...
            goto L_0x0148
        L_0x0140:
            java.lang.UnsupportedOperationException r13 = new java.lang.UnsupportedOperationException     // Catch:{ all -> 0x013e }
            java.lang.String r0 = "Failed to read EXIF from HEIF file. Given stream is either malformed or unsupported."
            r13.<init>(r0)     // Catch:{ all -> 0x013e }
    ...
    private void copyChunksUpToGivenChunkType(ByteOrderedDataInputStream byteOrderedDataInputStream, ByteOrderedDataOutputStream byteOrderedDataOutputStream, byte[] bArr, byte[] bArr2) throws IOException {
        ...
        while (true) {
            ...
            if (byteOrderedDataInputStream.read(bArr3) != 4) {
                ...
                StringBuilder append2 = append.append(new String(bArr, charset));
                if (bArr2 == null) {
                    str = "";
                } else {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:91:0x0299  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r30, int r31) throws java.io.IOException {
        ...
        L_0x020d:
            ...
            if (r13 == r6) goto L_0x0229
            r6 = 9
            if (r13 == r6) goto L_0x0224
            r6 = 13
            if (r13 == r6) goto L_0x0224
            goto L_0x0238
        L_0x0224:
