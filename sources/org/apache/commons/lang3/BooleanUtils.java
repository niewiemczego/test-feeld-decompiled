...
public class BooleanUtils {
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE, Constants.CASEFIRST_FALSE, (String) null);
    }
    ...
    public static String toStringYesNo(Boolean bool) {
        return toString(bool, "yes", SVGParser.XML_STYLESHEET_ATTR_ALTERNATE_NO, (String) null);
    }
    ...
    public static String toStringTrueFalse(boolean z) {
        return toString(z, ServerProtocol.DIALOG_RETURN_SCOPES_TRUE, Constants.CASEFIRST_FALSE);
    }
