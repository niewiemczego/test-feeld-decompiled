...
final class PreDrawBlurController implements BlurController {
    ...
    PreDrawBlurController(BlurView blurView2, ViewGroup viewGroup, int i, BlurAlgorithm blurAlgorithm2) {
        this.rootView = viewGroup;
        this.blurView = blurView2;
        this.overlayColor = i;
        this.blurAlgorithm = blurAlgorithm2;
        if (blurAlgorithm2 instanceof RenderEffectBlur) {
            ((RenderEffectBlur) blurAlgorithm2).setContext(blurView2.getContext());
        }
        init(blurView2.getMeasuredWidth(), blurView2.getMeasuredHeight());
    }
