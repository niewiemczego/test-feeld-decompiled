...
public final class DelayKt {
    ...
    public static final Object m2500delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2501toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2501toDelayMillisLRDsOJo(long j) {
        if (Duration.m2327compareToLRDsOJo(j, Duration.Companion.m2430getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2346getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
