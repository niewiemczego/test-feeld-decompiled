...
public final class WorkQueue {
    ...
    private final Task tryExtractFromTheMiddle(int i, boolean z) {
        ...
        if (task != null) {
            ...
            if (z2 == z && Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i2, task, (Object) null)) {
                if (z) {
    ...
    private final long tryStealLastScheduled(int i, Ref.ObjectRef<Task> objectRef) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, t, (Object) null));
        objectRef.element = t;
        return -1;
    }
    ...
    private final Task pollBuffer() {
        ...
        while (true) {
            ...
            int i2 = i & 127;
            if (atomicIntegerFieldUpdater.compareAndSet(this, i, i + 1) && (andSet = this.buffer.getAndSet(i2, (Object) null)) != null) {
