    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m983constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m983constructorimpl(Unit.INSTANCE);
        if (Result.m990isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2537successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2535closedJP2dKIU(Result.m986exceptionOrNullimpl(obj2));
        }
