...
final class KClassImpl$Data$descriptor$2 extends Lambda implements Function0<ClassDescriptor> {
    ...
    public final ClassDescriptor invoke() {
        ...
        if (access$getClassId.isLocal()) {
            ...
            classDescriptor = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleData.getModule(), access$getClassId);
        }
        if (classDescriptor != null) {
            return classDescriptor;
        }
        Void unused = this.this$0.reportUnresolvedClass();
        throw null;
    }
}
