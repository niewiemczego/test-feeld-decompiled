...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    private final LazyJavaPackageFragment getPackageFragment(FqName fqName) {
        JavaPackage findPackage$default = JavaClassFinder.DefaultImpls.findPackage$default(this.c.getComponents().getFinder(), fqName, false, 2, (Object) null);
    ...
    public boolean isEmpty(FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return JavaClassFinder.DefaultImpls.findPackage$default(this.c.getComponents().getFinder(), fqName, false, 2, (Object) null) == null;
    }
