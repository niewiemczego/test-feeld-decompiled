...
public class JavaDescriptorVisibilities {
    ...
    static {
        AnonymousClass1 r0 = new DelegatedDescriptorVisibility(JavaVisibilities.PackageVisibility.INSTANCE) {
            private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        AnonymousClass2 r1 = new DelegatedDescriptorVisibility(JavaVisibilities.ProtectedStaticVisibility.INSTANCE) {
            private static /* synthetic */ void $$$reportNull$$$0(int i) {
                Object[] objArr = new Object[3];
                if (i != 1) {
                    objArr[0] = "what";
        ...
        AnonymousClass3 r2 = new DelegatedDescriptorVisibility(JavaVisibilities.ProtectedAndPackage.INSTANCE) {
            private static /* synthetic */ void $$$reportNull$$$0(int i) {
                Object[] objArr = new Object[3];
                if (i != 1) {
                    objArr[0] = "what";
