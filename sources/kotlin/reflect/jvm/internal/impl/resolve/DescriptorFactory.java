...
public class DescriptorFactory {
    ...
    public static ReceiverParameterDescriptor createContextReceiverParameterForCallable(CallableDescriptor callableDescriptor, KotlinType kotlinType, Annotations annotations) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(31);
        }
        if (annotations == null) {
    ...
    public static ReceiverParameterDescriptor createContextReceiverParameterForClass(ClassDescriptor classDescriptor, KotlinType kotlinType, Annotations annotations) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(33);
        }
        if (annotations == null) {
