...
public final class BuiltInSerializerProtocol extends SerializerExtensionProtocol {
    ...
    public final String getBuiltInsFilePath(FqName fqName) {
        ...
        return sb.append(StringsKt.replace$default(asString, '.', (char) IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null)).append(IOUtils.DIR_SEPARATOR_UNIX).append(getBuiltInsFileName(fqName)).toString();
    }
