        ...
        for (Field field : declaredFields) {
            if ((field.getModifiers() & 8) == 0) {
                ...
                if (observableProperty != null) {
                    ...
                    field.set(descriptorRendererOptionsImpl, descriptorRendererOptionsImpl.property(observableProperty.getValue(this, new PropertyReference1Impl(orCreateKotlinClass, name2, append.append(name3).toString()))));
                }
            }
        }
