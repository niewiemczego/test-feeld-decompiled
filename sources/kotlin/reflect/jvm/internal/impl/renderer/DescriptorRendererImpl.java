...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    private final String renderForReceiver(KotlinType kotlinType) {
        ...
        return (!shouldRenderAsPrettyFunctionType(kotlinType) || TypeUtils.isNullableType(kotlinType)) ? renderType : '(' + renderType + ')';
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0096, code lost:
        if ((getDebugMode() ? r10.declaresDefaultValue() : kotlin.reflect.jvm.internal.impl.resolve.descriptorUtil.DescriptorUtilsKt.declaresOrInheritsDefaultValue(r10)) != false) goto L_0x009a;
     */
