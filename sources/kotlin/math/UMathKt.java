...
public final class UMathKt {
    ...
    private static final int m2203minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2185minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m2204mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2193minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m2201maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2173maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m2202maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2181maxOfeb3DHEI(j, j2);
    }
}
