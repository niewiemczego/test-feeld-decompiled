...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence removeSuffix(CharSequence charSequence, CharSequence charSequence2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(charSequence2, DynamicLink.Builder.KEY_SUFFIX);
    ...
    public static final String removeSuffix(String str, CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(charSequence, DynamicLink.Builder.KEY_SUFFIX);
    ...
    private static final String replaceFirstCharWithCharSequence(String str, Function1<? super Character, ? extends CharSequence> function1) {
        ...
        StringBuilder append = new StringBuilder().append(function1.invoke(Character.valueOf(str.charAt(0))));
        String substring = str.substring(1);
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
    ...
    public static final boolean toBooleanStrict(String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        if (Intrinsics.areEqual((Object) str, (Object) ServerProtocol.DIALOG_RETURN_SCOPES_TRUE)) {
            return true;
        }
        if (Intrinsics.areEqual((Object) str, (Object) Constants.CASEFIRST_FALSE)) {
            return false;
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String str) {
        ...
        return Intrinsics.areEqual((Object) str, (Object) Constants.CASEFIRST_FALSE) ? false : null;
    }
