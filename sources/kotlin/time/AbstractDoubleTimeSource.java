...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m2305minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m2323minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m2303elapsedNowUwyO8pc() {
            return Duration.m2363minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m2308plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m2364plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m2306minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m2333equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m2360isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m2430getZEROUwyO8pc();
                    }
                    long r2 = Duration.m2363minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m2333equalsimpl0(m2306minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m2430getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m2356hashCodeimpl(Duration.m2364plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m2377toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m2430getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
