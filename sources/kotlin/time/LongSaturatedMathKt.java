...
public final class LongSaturatedMathKt {
    ...
    public static final long m2456saturatingAddpTJri5U(long j, long j2) {
        long r4 = Duration.m2348getInWholeNanosecondsimpl(j2);
        boolean z = true;
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2455checkInfiniteSumDefinedPjuGub4(j, j2, r4);
        }
        if ((1 | (r4 - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m2457saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + r4;
        if (((j ^ j3) & (r4 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m2455checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2360isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2457saturatingAddInHalvespTJri5U(long j, long j2) {
        long r0 = Duration.m2331divUwyO8pc(j2, 2);
        if (((Duration.m2348getInWholeNanosecondsimpl(r0) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (((double) j) + Duration.m2371toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m2456saturatingAddpTJri5U(m2456saturatingAddpTJri5U(j, r0), Duration.m2363minusLRDsOJo(j2, r0));
    }

    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2380unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m2364plusLRDsOJo(duration, DurationKt.toDuration(j5, DurationUnit.NANOSECONDS));
        }
