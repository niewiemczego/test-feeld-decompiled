...
public class ReactNativeFirebaseEventEmitter {
    ...
    public void attachReactContext(ReactContext reactContext2) {
        this.handler.post(new ReactNativeFirebaseEventEmitter$$ExternalSyntheticLambda3(this, reactContext2));
    }
    ...
    public /* synthetic */ void m856lambda$attachReactContext$0$ioinvertasefirebasecommonReactNativeFirebaseEventEmitter(ReactContext reactContext2) {
        this.reactContext = reactContext2;
        sendQueuedEvents();
    }

    public void notifyJsReady(Boolean bool) {
        this.handler.post(new ReactNativeFirebaseEventEmitter$$ExternalSyntheticLambda2(this, bool));
    }
    ...
    public /* synthetic */ void m857lambda$notifyJsReady$1$ioinvertasefirebasecommonReactNativeFirebaseEventEmitter(Boolean bool) {
        this.jsReady = bool;
        sendQueuedEvents();
    }

    public void sendEvent(NativeEvent nativeEvent) {
        this.handler.post(new ReactNativeFirebaseEventEmitter$$ExternalSyntheticLambda1(this, nativeEvent));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$sendEvent$2$io-invertase-firebase-common-ReactNativeFirebaseEventEmitter  reason: not valid java name */
    public /* synthetic */ void m858lambda$sendEvent$2$ioinvertasefirebasecommonReactNativeFirebaseEventEmitter(NativeEvent nativeEvent) {
