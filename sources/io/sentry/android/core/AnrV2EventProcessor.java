...
public final class AnrV2EventProcessor implements BackfillingEventProcessor {
    ...
    public AnrV2EventProcessor(Context context2, SentryAndroidOptions sentryAndroidOptions, BuildInfoProvider buildInfoProvider2) {
    ...
    private void setFingerprints(SentryEvent sentryEvent, Object obj) {
        List list = (List) PersistingScopeObserver.read(this.options, PersistingScopeObserver.FINGERPRINT_FILENAME, List.class);
    ...
    private void setContexts(SentryBaseEvent sentryBaseEvent) {
        ...
        if (contexts != null) {
            ...
            for (Map.Entry entry : new Contexts(contexts).entrySet()) {
                Object value = entry.getValue();
                if ((!"trace".equals(entry.getKey()) || !(value instanceof SpanContext)) && !contexts2.containsKey(entry.getKey())) {
                    contexts2.put((String) entry.getKey(), value);
                }
            }
        }
    }
    ...
    private void setApp(SentryBaseEvent sentryBaseEvent, Object obj) {
        ...
        if (str != null) {
            try {
                ...
                app2.setAppVersion(substring);
                app2.setAppBuild(substring2);
    ...
    private void setSideLoadedInfo(SentryBaseEvent sentryBaseEvent) {
        try {
            ...
            if (retrieveSideLoadedInfo != null) {
                for (Map.Entry next : retrieveSideLoadedInfo.asTags().entrySet()) {
    ...
    private OperatingSystem getOperatingSystem() {
        ...
        operatingSystem.setName(AndroidContextProvider.PLATFORM);
