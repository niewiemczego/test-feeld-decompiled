...
public class ThreadDumpParser {
    ...
    private SentryThread parseThread(Lines lines) {
        ...
        if (matches(matcher, next.text)) {
            Long l = getLong(matcher, 4, (Long) null);
            if (l == null) {
            ...
            Long l2 = getLong(matcher2, 3, (Long) null);
            if (l2 == null) {
                this.options.getLogger().log(SentryLevel.DEBUG, "No thread id in the dump, skipping thread.", new Object[0]);
                return null;
            }
    ...
    private SentryStackTrace parseStacktrace(Lines lines, SentryThread sentryThread) {
        Matcher matcher;
        SentryThread sentryThread2 = sentryThread;
        ArrayList arrayList = new ArrayList();
        ...
        while (true) {
            ...
            if (matches(matcher2, str)) {
                ...
                sentryStackFrame2.setLineno(getInteger(matcher2, 3, (Integer) null));
                ...
                if (matches(matcher4, str)) {
                    ...
                    String format = String.format("%s.%s", new Object[]{matcher4.group(1), matcher4.group(2)});
                    ...
                    sentryStackFrame.setLineno(getUInteger(matcher4, 5, (Integer) null));
                    ...
                    sentryStackFrame = new SentryStackFrame();
                    String format2 = String.format("%s.%s", new Object[]{matcher5.group(1), matcher5.group(2)});
                    ...
                    if (sentryStackFrame != null) {
                        ...
                        combineThreadLocks(sentryThread2, sentryLockReason);
                    }
                    ...
                    if (sentryStackFrame != null) {
                        ...
                        combineThreadLocks(sentryThread2, sentryLockReason2);
                    }
                    ...
                    if (!matches(matcher9, str)) {
                        if (!matches(matcher10, str)) {
                            if (!matches(matcher11, str)) {
                                ...
                                combineThreadLocks(sentryThread2, sentryLockReason3);
                            }
                        } else if (sentryStackFrame != null) {
                            ...
                            combineThreadLocks(sentryThread2, sentryLockReason4);
                        }
                    } else if (sentryStackFrame != null) {
                        ...
                        sentryLockReason5.setThreadId(getLong(matcher9, 4, (Long) null));
                        sentryStackFrame.setLock(sentryLockReason5);
                        combineThreadLocks(sentryThread2, sentryLockReason5);
                    }
                    matcher12 = matcher13;
                    matcher2 = matcher;
                } else if (sentryStackFrame != null) {
                    ...
                    combineThreadLocks(sentryThread2, sentryLockReason6);
                }
                matcher12 = matcher13;
                matcher2 = matcher;
            }
