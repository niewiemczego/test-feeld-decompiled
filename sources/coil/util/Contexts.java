    ...
    public static final Drawable getXmlDrawableCompat(Context context, Resources resources, int i) {
        ...
        if (next == 2) {
            if (Build.VERSION.SDK_INT < 24) {
                ...
                if (Intrinsics.areEqual((Object) name, (Object) "vector")) {
                    XmlPullParser xmlPullParser = xml;
                    return VectorDrawableCompat.createFromXmlInner(resources, xmlPullParser, Xml.asAttributeSet(xmlPullParser), context.getTheme());
                } else if (Intrinsics.areEqual((Object) name, (Object) "animated-vector")) {
                    XmlPullParser xmlPullParser2 = xml;
                    return AnimatedVectorDrawableCompat.createFromXmlInner(context, resources, xmlPullParser2, Xml.asAttributeSet(xmlPullParser2), context.getTheme());
                }
            }
