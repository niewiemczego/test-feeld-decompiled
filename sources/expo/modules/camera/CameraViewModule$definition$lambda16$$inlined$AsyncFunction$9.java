...
/* renamed from: expo.modules.camera.CameraViewModule$definition$lambda-16$$inlined$AsyncFunction$9  reason: invalid class name */
/* compiled from: ObjectDefinitionBuilder.kt */
public final class CameraViewModule$definition$lambda16$$inlined$AsyncFunction$9 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ CameraViewModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CameraViewModule$definition$lambda16$$inlined$AsyncFunction$9(CameraViewModule cameraViewModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (access$findView.getCameraView$expo_camera_release().isCameraOpened()) {
            access$findView.getCameraView$expo_camera_release().stopRecording();
        }
    }
