...
public final class BigInt64Array implements TypedArray, GenericTypedArray<Long> {
    ...
    public BigInt64Array(JavaScriptTypedArray javaScriptTypedArray) {
    ...
    public /* bridge */ /* synthetic */ void set(int i, Object obj) {
        set(i, ((Number) obj).longValue());
    }

    public Long get(int i) {
        TypedArray typedArray = this;
        if (i >= 0 && i < typedArray.getLength()) {
            return Long.valueOf(read8Byte(i * 8));
        }
