...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$7 extends DynamicAwareTypeConverters<ReadableArray> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$7(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public ReadableArray convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (ReadableArray) obj;
    }

    public ReadableArray convertFromDynamic(Dynamic dynamic) {
