...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$1 extends DynamicAwareTypeConverters<Integer> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$1(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public Integer convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (Integer) obj;
    }

    public Integer convertFromDynamic(Dynamic dynamic) {
