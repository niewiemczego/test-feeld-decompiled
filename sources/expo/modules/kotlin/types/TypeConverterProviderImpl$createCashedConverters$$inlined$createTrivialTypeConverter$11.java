...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$11 extends DynamicAwareTypeConverters<float[]> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$11(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public float[] convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (float[]) obj;
    }

    public float[] convertFromDynamic(Dynamic dynamic) {
