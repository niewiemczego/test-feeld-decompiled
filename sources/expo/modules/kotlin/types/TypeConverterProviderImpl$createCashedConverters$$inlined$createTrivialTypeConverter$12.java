...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$12 extends DynamicAwareTypeConverters<boolean[]> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$12(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public boolean[] convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (boolean[]) obj;
    }

    public boolean[] convertFromDynamic(Dynamic dynamic) {
