...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$4 extends DynamicAwareTypeConverters<Float> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$4(boolean z, ExpectedType expectedType) {
        super(z);
