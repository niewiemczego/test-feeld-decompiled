...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$10 extends DynamicAwareTypeConverters<double[]> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$10(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public double[] convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (double[]) obj;
    }

    public double[] convertFromDynamic(Dynamic dynamic) {
