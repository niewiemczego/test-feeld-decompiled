...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$6 extends DynamicAwareTypeConverters<String> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$6(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public String convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (String) obj;
    }

    public String convertFromDynamic(Dynamic dynamic) {
