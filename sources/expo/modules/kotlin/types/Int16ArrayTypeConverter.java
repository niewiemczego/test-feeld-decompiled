...
public final class Int16ArrayTypeConverter extends BaseTypeArrayConverter<Int16Array> {
    ...
    public Int16Array wrapJavaScriptTypedArray(JavaScriptTypedArray javaScriptTypedArray) {
        Intrinsics.checkNotNullParameter(javaScriptTypedArray, "value");
        return new Int16Array(javaScriptTypedArray);
    }
}
