...
public final class TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$2 extends DynamicAwareTypeConverters<Long> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCashedConverters$$inlined$createTrivialTypeConverter$2(boolean z, ExpectedType expectedType) {
        super(z);
    ...
    public Long convertFromAny(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "value");
        return (Long) obj;
    }

    public Long convertFromDynamic(Dynamic dynamic) {
