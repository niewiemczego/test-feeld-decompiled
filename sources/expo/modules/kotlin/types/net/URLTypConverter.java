...
public final class URLTypConverter extends DynamicAwareTypeConverters<URL> {
    ...
    public URL convertFromDynamic(Dynamic dynamic) {
        Intrinsics.checkNotNullParameter(dynamic, "value");
        return new URL(dynamic.asString());
    }

    public URL convertFromAny(Object obj) {
