...
public final class FileSystemModule$downloadResumableStartAsync$progressListener$1$update$$inlined$moduleRegistry$1 extends Lambda implements Function0<EventEmitter> {
    final /* synthetic */ ModuleRegistryDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FileSystemModule$downloadResumableStartAsync$progressListener$1$update$$inlined$moduleRegistry$1(ModuleRegistryDelegate moduleRegistryDelegate) {
        super(0);
        this.this$0 = moduleRegistryDelegate;
    }

    /* JADX WARNING: type inference failed for: r0v2, types: [java.lang.Object, expo.modules.core.interfaces.services.EventEmitter] */
