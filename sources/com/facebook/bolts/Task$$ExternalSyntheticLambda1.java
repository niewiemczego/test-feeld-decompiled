...
public final /* synthetic */ class Task$$ExternalSyntheticLambda1 implements Continuation {
    ...
    public /* synthetic */ Task$$ExternalSyntheticLambda1(TaskCompletionSource taskCompletionSource, Continuation continuation, Executor executor, CancellationToken cancellationToken) {
    ...
    public final Object then(Task task) {
        return Task.m293continueWith$lambda10$lambda9(this.f$0, this.f$1, this.f$2, this.f$3, task);
    }
}
