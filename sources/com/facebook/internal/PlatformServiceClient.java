...
public abstract class PlatformServiceClient implements ServiceConnection {
    ...
    public final boolean start() {
        /*
            r4 = this;
            monitor-enter(r4)
            boolean r0 = r4.running     // Catch:{ all -> 0x0032 }
            r1 = 0
            if (r0 == 0) goto L_0x0008
            monitor-exit(r4)
            return r1
        L_0x0008:
            com.facebook.internal.NativeProtocol r0 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x0032 }
            int r0 = r4.protocolVersion     // Catch:{ all -> 0x0032 }
            int r0 = com.facebook.internal.NativeProtocol.getLatestAvailableProtocolVersionForService(r0)     // Catch:{ all -> 0x0032 }
            r2 = -1
        ...
        L_0x0015:
            com.facebook.internal.NativeProtocol r0 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x0032 }
            android.content.Context r0 = r4.getContext()     // Catch:{ all -> 0x0032 }
            android.content.Intent r0 = com.facebook.internal.NativeProtocol.createPlatformServiceIntent(r0)     // Catch:{ all -> 0x0032 }
            r2 = 1
            if (r0 != 0) goto L_0x0023
            goto L_0x0030
        L_0x0023:
            r4.running = r2     // Catch:{ all -> 0x0032 }
            android.content.Context r1 = r4.getContext()     // Catch:{ all -> 0x0032 }
            r3 = r4
            android.content.ServiceConnection r3 = (android.content.ServiceConnection) r3     // Catch:{ all -> 0x0032 }
            r1.bindService(r0, r3, r2)     // Catch:{ all -> 0x0032 }
            r1 = r2
        L_0x0030:
            monitor-exit(r4)
            return r1
