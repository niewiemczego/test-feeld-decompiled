...
public final class InstrumentData {
    ...
    private InstrumentData(JSONArray jSONArray) {
        ...
        String stringBuffer = new StringBuffer().append(InstrumentUtility.ANALYSIS_REPORT_PREFIX).append(String.valueOf(this.timestamp)).append(".json").toString();
    ...
    private InstrumentData(String str, String str2) {
        ...
        this.timestamp = Long.valueOf(System.currentTimeMillis() / ((long) 1000));
        String stringBuffer = new StringBuffer().append(InstrumentUtility.ANR_REPORT_PREFIX).append(String.valueOf(this.timestamp)).append(".json").toString();
    ...
    private final JSONObject getAnalysisReportParameters() {
        ...
        try {
            ...
            if (jSONArray != null) {
                jSONObject.put(PARAM_FEATURE_NAMES, (Object) jSONArray);
            }
            Long l = this.timestamp;
            if (l != null) {
    ...
    private final JSONObject getExceptionReportParameters() {
        ...
        try {
            ...
            if (str3 != null) {
                jSONObject.put(PARAM_CALLSTACK, (Object) str3);
            }
            Type type2 = this.type;
            if (type2 != null) {
                jSONObject.put("type", (Object) type2);
            }
            return jSONObject;
        } catch (JSONException unused) {
            return null;
    ...
    public static final class Builder {
        ...
        public static final InstrumentData build(Throwable th, Type type) {
            Intrinsics.checkNotNullParameter(type, Constants.BRAZE_PUSH_TITLE_KEY);
