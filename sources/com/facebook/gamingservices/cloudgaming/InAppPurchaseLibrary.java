...
public class InAppPurchaseLibrary {
    ...
    public static void purchase(Context context, String str, String str2, DaemonRequest.Callback callback) {
        try {
            DaemonRequest.executeAsync(context, new JSONObject().put(SDKConstants.PARAM_PRODUCT_ID, (Object) str).put(SDKConstants.PARAM_DEVELOPER_PAYLOAD, (Object) str2), callback, SDKMessageEnum.PURCHASE);
    ...
    public static void consumePurchase(Context context, String str, DaemonRequest.Callback callback) {
        try {
            DaemonRequest.executeAsync(context, new JSONObject().put(SDKConstants.PARAM_PURCHASE_TOKEN, (Object) str), callback, SDKMessageEnum.CONSUME_PURCHASE);
        } catch (JSONException e) {
    ...
    public static void purchaseSubscription(Context context, String str, DaemonRequest.Callback callback) {
        try {
            DaemonRequest.executeAsync(context, new JSONObject().put(SDKConstants.PARAM_PRODUCT_ID, (Object) str), callback, SDKMessageEnum.PURCHASE_SUBSCRIPTION);
        } catch (JSONException e) {
    ...
    public static void cancelSubscription(Context context, String str, DaemonRequest.Callback callback) {
        try {
            DaemonRequest.executeAsync(context, new JSONObject().put(SDKConstants.PARAM_PURCHASE_TOKEN, (Object) str), callback, SDKMessageEnum.CANCEL_SUBSCRIPTION);
        } catch (JSONException e) {
