...
public final class ContextSwitchDialog extends FacebookDialogBase<ContextSwitchContent, Result> {
    ...
    private final void showForCloud(ContextSwitchContent contextSwitchContent) {
        ...
        try {
            jSONObject.put("id", (Object) contextID);
    ...
    public static final void m316showForCloud$lambda2(ContextSwitchDialog contextSwitchDialog, GraphResponse graphResponse) {
        Unit unit;
    ...
    public static final boolean m315registerCallbackImpl$lambda3(ContextSwitchDialog contextSwitchDialog, ResultProcessor resultProcessor, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(contextSwitchDialog, "this$0");
