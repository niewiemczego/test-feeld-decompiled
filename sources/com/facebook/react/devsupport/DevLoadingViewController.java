...
public class DevLoadingViewController {
    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                URL url = new URL(str);
                showMessage(context.getString(R.string.catalyst_loading_from_url, new Object[]{url.getHost() + CertificateUtil.DELIMITER + (url.getPort() != -1 ? url.getPort() : url.getDefaultPort())}));
