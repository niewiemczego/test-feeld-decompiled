...
class TransformAnimatedNode extends AnimatedNode {
    ...
    public String prettyPrint() {
        StringBuilder append = new StringBuilder().append("TransformAnimatedNode[").append(this.mTag).append("]: mTransformConfigs: ");
        List<TransformConfig> list = this.mTransformConfigs;
        return append.append(list != null ? list.toString() : "null").toString();
    }
}
