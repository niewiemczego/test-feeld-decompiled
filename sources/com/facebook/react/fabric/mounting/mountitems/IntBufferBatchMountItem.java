                            ...
                            if (i11 == 8) {
                                ...
                                if (i11 == 32) {
                                    ...
                                    if (i11 == 512) {
                                        ...
                                        castToCppViewMutationWrapper(this.mObjBuffer[i13]).runCppViewMutations();
                                        i13++;
                                    } else {
                ...
                while (true) {
                    if (i11 < i) {
                        if (i10 == 2) {
                            int i12 = i6 + 1;
                            i5 = i12 + 1;
                            sb.append(String.format("CREATE [%d] - layoutable:%d - %s\n", new Object[]{Integer.valueOf(this.mIntBuffer[i6]), Integer.valueOf(this.mIntBuffer[i12]), FabricComponents.getFabricComponentName((String) this.mObjBuffer[i7])}));
                            i7 = i7 + 1 + 3;
                        } else {
                            if (i10 == 4) {
                                i2 = i6 + 1;
