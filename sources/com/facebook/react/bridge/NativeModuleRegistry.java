...
public class NativeModuleRegistry {
        ...
        for (Map.Entry next : this.mModules.entrySet()) {
            if (!((ModuleHolder) next.getValue()).isCxxModule()) {
                if (ReactFeatureFlags.warnOnLegacyNativeModuleSystemUse) {
                    ReactSoftExceptionLogger.logSoftException(this.TAG, new ReactNoCrashSoftException("Registering legacy NativeModule: Java NativeModule (name = \"" + ((ModuleHolder) next.getValue()).getName() + "\", className = " + ((ModuleHolder) next.getValue()).getClassName() + ")."));
                }
    ...
    public Collection<ModuleHolder> getCxxModules() {
        ...
        for (Map.Entry next : this.mModules.entrySet()) {
            if (((ModuleHolder) next.getValue()).isCxxModule()) {
                if (ReactFeatureFlags.warnOnLegacyNativeModuleSystemUse) {
                    ReactSoftExceptionLogger.logSoftException(this.TAG, new ReactNoCrashSoftException("Registering legacy NativeModule: Cxx NativeModule (name = \"" + ((ModuleHolder) next.getValue()).getName() + "\", className = " + ((ModuleHolder) next.getValue()).getClassName() + ")."));
                }
