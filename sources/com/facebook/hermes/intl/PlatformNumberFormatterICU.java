...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x003e, code lost:
        return android.icu.text.NumberFormat.getInstance(android.icu.util.ULocale.forLanguageTag(com.adapty.internal.utils.UtilsKt.DEFAULT_PAYWALL_LOCALE)).format(r5);
     */
