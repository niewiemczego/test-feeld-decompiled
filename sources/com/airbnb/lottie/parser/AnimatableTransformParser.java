...
public class AnimatableTransformParser {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of(Constants.BRAZE_PUSH_CONTENT_KEY, "p", Constants.BRAZE_PUSH_SUMMARY_TEXT_KEY, "rz", "r", "o", "so", "eo", "sk", "sa");
