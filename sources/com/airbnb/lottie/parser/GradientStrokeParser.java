...
class GradientStrokeParser {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "g", "o", Constants.BRAZE_PUSH_TITLE_KEY, Constants.BRAZE_PUSH_SUMMARY_TEXT_KEY, "e", "w", "lc", "lj", "ml", "hd", Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE);
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals(Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE) || str2.equals("g")) {
