...
public class AnimatableTextPropertiesParser {
    private static final JsonReader.Options ANIMATABLE_PROPERTIES_NAMES = JsonReader.Options.of("fc", "sc", "sw", Constants.BRAZE_PUSH_TITLE_KEY);
    private static final JsonReader.Options PROPERTIES_NAMES = JsonReader.Options.of(Constants.BRAZE_PUSH_CONTENT_KEY);
