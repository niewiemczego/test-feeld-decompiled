...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.of(Constants.BRAZE_PUSH_TITLE_KEY, Constants.BRAZE_PUSH_SUMMARY_TEXT_KEY, "e", "o", ContextChain.TAG_INFRA, "h", "to", "ti");
