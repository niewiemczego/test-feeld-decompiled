...
public final class SignInWebViewClient extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        if (Intrinsics.areEqual((Object) webResourceRequest != null ? webResourceRequest.getMethod() : null, (Object) ShareTarget.METHOD_POST)) {
    ...
    public static final void m89shouldInterceptRequest$lambda0(WebView webView, SignInWebViewClient signInWebViewClient) {
        Intrinsics.checkNotNullParameter(signInWebViewClient, "this$0");
        if (webView != null) {
            webView.stopLoading();
        }
        if (webView != null) {
            webView.loadUrl(InAppMessageWebViewClient.JAVASCRIPT_PREFIX + signInWebViewClient.javascriptToInject);
        }
    }
}
