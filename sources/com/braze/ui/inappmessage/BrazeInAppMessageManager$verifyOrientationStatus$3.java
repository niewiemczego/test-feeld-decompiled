...
final class BrazeInAppMessageManager$verifyOrientationStatus$3 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$verifyOrientationStatus$3() {
        super(0);
    }
