...
final class BrazeInAppMessageManager$requestDisplayInAppMessage$5 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$requestDisplayInAppMessage$5() {
        super(0);
    }
