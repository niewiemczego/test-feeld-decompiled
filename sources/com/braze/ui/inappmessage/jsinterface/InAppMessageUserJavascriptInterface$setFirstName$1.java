...
final class InAppMessageUserJavascriptInterface$setFirstName$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $firstName;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setFirstName$1(String str) {
        super(1);
        this.$firstName = str;
    }
