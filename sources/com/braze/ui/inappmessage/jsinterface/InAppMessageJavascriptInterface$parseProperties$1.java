...
final class InAppMessageJavascriptInterface$parseProperties$1 extends Lambda implements Function0<String> {
    final /* synthetic */ String $propertiesJSON;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageJavascriptInterface$parseProperties$1(String str) {
        super(0);
