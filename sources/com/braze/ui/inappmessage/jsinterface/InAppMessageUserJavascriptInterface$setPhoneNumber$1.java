...
final class InAppMessageUserJavascriptInterface$setPhoneNumber$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $phoneNumber;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setPhoneNumber$1(String str) {
        super(1);
