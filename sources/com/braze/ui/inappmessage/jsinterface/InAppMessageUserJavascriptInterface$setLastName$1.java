...
final class InAppMessageUserJavascriptInterface$setLastName$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $lastName;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setLastName$1(String str) {
        super(1);
        this.$lastName = str;
    }
