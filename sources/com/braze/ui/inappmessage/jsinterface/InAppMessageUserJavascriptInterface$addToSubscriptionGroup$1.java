...
final class InAppMessageUserJavascriptInterface$addToSubscriptionGroup$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $subscriptionGroupId;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$addToSubscriptionGroup$1(String str) {
        super(1);
