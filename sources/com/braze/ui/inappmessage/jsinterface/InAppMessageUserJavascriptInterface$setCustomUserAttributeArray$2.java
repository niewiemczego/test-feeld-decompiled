...
final class InAppMessageUserJavascriptInterface$setCustomUserAttributeArray$2 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String[] $arrayValue;
    final /* synthetic */ String $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setCustomUserAttributeArray$2(String str, String[] strArr) {
        super(1);
        this.$key = str;
