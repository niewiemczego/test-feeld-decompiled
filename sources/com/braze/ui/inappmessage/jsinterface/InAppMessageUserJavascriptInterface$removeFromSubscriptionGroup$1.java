...
final class InAppMessageUserJavascriptInterface$removeFromSubscriptionGroup$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $subscriptionGroupId;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$removeFromSubscriptionGroup$1(String str) {
        super(1);
