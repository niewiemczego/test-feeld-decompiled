...
final class InAppMessageUserJavascriptInterface$setCountry$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $country;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setCountry$1(String str) {
        super(1);
        this.$country = str;
    }
