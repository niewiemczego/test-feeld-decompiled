...
final class InAppMessageUserJavascriptInterface$setDateOfBirth$2 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ int $day;
    final /* synthetic */ Month $month;
    final /* synthetic */ int $year;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setDateOfBirth$2(int i, Month month, int i2) {
        super(1);
        this.$year = i;
        this.$month = month;
        this.$day = i2;
