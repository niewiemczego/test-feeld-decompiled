...
final class InAppMessageUserJavascriptInterface$setEmail$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $email;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setEmail$1(String str) {
        super(1);
        this.$email = str;
    }
