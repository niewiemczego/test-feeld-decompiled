...
final class InAppMessageUserJavascriptInterface$setLanguage$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $language;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageUserJavascriptInterface$setLanguage$1(String str) {
        super(1);
        this.$language = str;
    }
