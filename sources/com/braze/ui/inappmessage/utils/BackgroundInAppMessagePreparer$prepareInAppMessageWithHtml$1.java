...
final class BackgroundInAppMessagePreparer$prepareInAppMessageWithHtml$1 extends Lambda implements Function0<String> {
    ...
    BackgroundInAppMessagePreparer$prepareInAppMessageWithHtml$1() {
        super(0);
    }
