...
final class BrazeInAppMessageManager$requestDisplayInAppMessage$4 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$requestDisplayInAppMessage$4() {
        super(0);
    }
