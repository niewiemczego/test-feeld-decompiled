...
final class BrazeInAppMessageManager$resetAfterInAppMessageClose$1 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$resetAfterInAppMessageClose$1() {
        super(0);
    }
