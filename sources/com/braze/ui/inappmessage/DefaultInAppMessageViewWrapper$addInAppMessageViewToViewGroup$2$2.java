...
final class DefaultInAppMessageViewWrapper$addInAppMessageViewToViewGroup$2$2 extends Lambda implements Function0<String> {
    ...
    DefaultInAppMessageViewWrapper$addInAppMessageViewToViewGroup$2$2() {
        super(0);
    }
