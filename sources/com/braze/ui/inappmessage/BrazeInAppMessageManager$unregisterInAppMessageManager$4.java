...
final class BrazeInAppMessageManager$unregisterInAppMessageManager$4 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$unregisterInAppMessageManager$4() {
        super(0);
    }
