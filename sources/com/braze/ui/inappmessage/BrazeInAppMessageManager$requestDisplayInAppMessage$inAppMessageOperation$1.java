...
final class BrazeInAppMessageManager$requestDisplayInAppMessage$inAppMessageOperation$1 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$requestDisplayInAppMessage$inAppMessageOperation$1() {
        super(0);
    }
