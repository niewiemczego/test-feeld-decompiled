...
final class BrazeInAppMessageManager$requestDisplayInAppMessage$6 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$requestDisplayInAppMessage$6() {
        super(0);
    }
