...
final class DefaultInAppMessageWebViewClientListener$onCloseAction$1 extends Lambda implements Function0<String> {
    ...
    DefaultInAppMessageWebViewClientListener$onCloseAction$1() {
        super(0);
    }
