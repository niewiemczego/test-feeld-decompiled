...
final class InAppMessageManagerBase$setBackButtonDismissesInAppMessageView$1 extends Lambda implements Function0<String> {
    final /* synthetic */ boolean $backButtonDismissesInAppMessageView;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InAppMessageManagerBase$setBackButtonDismissesInAppMessageView$1(boolean z) {
        super(0);
