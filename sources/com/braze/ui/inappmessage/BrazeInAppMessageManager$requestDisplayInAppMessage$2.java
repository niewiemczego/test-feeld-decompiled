...
final class BrazeInAppMessageManager$requestDisplayInAppMessage$2 extends Lambda implements Function0<String> {
    ...
    BrazeInAppMessageManager$requestDisplayInAppMessage$2() {
        super(0);
    }
