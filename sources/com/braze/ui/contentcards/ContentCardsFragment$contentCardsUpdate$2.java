...
final class ContentCardsFragment$contentCardsUpdate$2 extends Lambda implements Function0<String> {
    final /* synthetic */ ContentCardsUpdatedEvent $event;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContentCardsFragment$contentCardsUpdate$2(ContentCardsUpdatedEvent contentCardsUpdatedEvent) {
        super(0);
