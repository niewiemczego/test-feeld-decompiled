...
final class ContentCardAdapter$onViewDetachedFromWindow$1 extends Lambda implements Function0<String> {
    final /* synthetic */ int $adapterPosition;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContentCardAdapter$onViewDetachedFromWindow$1(int i) {
        super(0);
