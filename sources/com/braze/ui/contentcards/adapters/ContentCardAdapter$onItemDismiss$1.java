...
final class ContentCardAdapter$onItemDismiss$1 extends Lambda implements Function0<String> {
    final /* synthetic */ int $position;
    final /* synthetic */ ContentCardAdapter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContentCardAdapter$onItemDismiss$1(int i, ContentCardAdapter contentCardAdapter) {
        super(0);
        this.$position = i;
