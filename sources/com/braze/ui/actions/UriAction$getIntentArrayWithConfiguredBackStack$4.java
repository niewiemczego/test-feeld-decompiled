...
final class UriAction$getIntentArrayWithConfiguredBackStack$4 extends Lambda implements Function0<String> {
    final /* synthetic */ String $activityClass;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UriAction$getIntentArrayWithConfiguredBackStack$4(String str) {
        super(0);
