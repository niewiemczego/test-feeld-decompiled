...
final class AddToCustomAttributeArrayStep$run$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $key;
    final /* synthetic */ String $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AddToCustomAttributeArrayStep$run$1(String str, String str2) {
        super(1);
        this.$key = str;
        this.$value = str2;
    }
