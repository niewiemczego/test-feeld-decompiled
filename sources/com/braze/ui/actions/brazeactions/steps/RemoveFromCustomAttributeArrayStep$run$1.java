...
final class RemoveFromCustomAttributeArrayStep$run$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ StepData $data;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RemoveFromCustomAttributeArrayStep$run$1(StepData stepData) {
        super(1);
        this.$data = stepData;
    }
