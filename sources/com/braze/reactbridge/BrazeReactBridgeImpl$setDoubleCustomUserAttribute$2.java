...
final class BrazeReactBridgeImpl$setDoubleCustomUserAttribute$2 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ Callback $callback;
    final /* synthetic */ String $key;
    final /* synthetic */ float $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeReactBridgeImpl$setDoubleCustomUserAttribute$2(Callback callback, String str, float f) {
        super(1);
