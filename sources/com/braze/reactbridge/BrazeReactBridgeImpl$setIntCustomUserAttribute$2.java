...
final class BrazeReactBridgeImpl$setIntCustomUserAttribute$2 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ Callback $callback;
    final /* synthetic */ String $key;
    final /* synthetic */ int $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeReactBridgeImpl$setIntCustomUserAttribute$2(Callback callback, String str, int i) {
        super(1);
