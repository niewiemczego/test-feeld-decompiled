...
final class BrazeReactBridgeImpl$setDateOfBirth$1 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ int $day;
    final /* synthetic */ int $month;
    final /* synthetic */ int $year;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeReactBridgeImpl$setDateOfBirth$1(int i, int i2, int i3) {
        super(1);
        this.$month = i;
        this.$year = i2;
        this.$day = i3;
    ...
    public final void invoke(BrazeUser brazeUser) {
        ...
        if (month != null) {
            brazeUser.setDateOfBirth(this.$year, month, this.$day);
        }
    }
}
