...
final class BrazeReactBridgeImpl$addAlias$3 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ String $aliasLabel;
    final /* synthetic */ String $aliasName;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeReactBridgeImpl$addAlias$3(String str, String str2) {
        super(1);
        this.$aliasName = str;
    ...
    public final void invoke(BrazeUser brazeUser) {
        ...
        brazeUser.addAlias(this.$aliasName, this.$aliasLabel);
    }
}
