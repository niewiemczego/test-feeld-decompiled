...
final class BrazeReactBridgeImpl$setAttributionData$2 extends Lambda implements Function1<BrazeUser, Unit> {
    final /* synthetic */ AttributionData $attributionData;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeReactBridgeImpl$setAttributionData$2(AttributionData attributionData) {
        super(1);
    ...
    public final void invoke(BrazeUser brazeUser) {
        ...
        brazeUser.setAttributionData(this.$attributionData);
    }
}
