...
final class NotificationTrampolineActivity$onResume$3 extends Lambda implements Function0<String> {
    final /* synthetic */ Intent $receivedIntent;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationTrampolineActivity$onResume$3(Intent intent) {
        super(0);
