...
final class BrazeNotificationStyleFactory$Companion$populatePushStoryPage$3 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationStyleFactory$Companion$populatePushStoryPage$3() {
        super(0);
    }
