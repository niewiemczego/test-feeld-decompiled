...
final class BrazeNotificationStyleFactory$Companion$getBigPictureNotificationStyle$4 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationStyleFactory$Companion$getBigPictureNotificationStyle$4() {
        super(0);
    }
