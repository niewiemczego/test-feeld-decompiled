...
final class BrazeNotificationUtils$requestGeofenceRefreshIfAppropriate$2 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationUtils$requestGeofenceRefreshIfAppropriate$2() {
        super(0);
    }
