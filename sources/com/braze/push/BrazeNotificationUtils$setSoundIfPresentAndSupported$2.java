...
final class BrazeNotificationUtils$setSoundIfPresentAndSupported$2 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationUtils$setSoundIfPresentAndSupported$2() {
        super(0);
    }
