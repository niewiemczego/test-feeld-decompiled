...
final class BrazeNotificationStyleFactory$Companion$getNotificationStyle$3 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationStyleFactory$Companion$getNotificationStyle$3() {
        super(0);
    }
