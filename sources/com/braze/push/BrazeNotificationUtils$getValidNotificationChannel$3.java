...
final class BrazeNotificationUtils$getValidNotificationChannel$3 extends Lambda implements Function0<String> {
    final /* synthetic */ String $channelIdFromExtras;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeNotificationUtils$getValidNotificationChannel$3(String str) {
        super(0);
