...
final class BrazeNotificationStyleFactory$Companion$getInlineImageStyle$2 extends Lambda implements Function0<String> {
    ...
    BrazeNotificationStyleFactory$Companion$getInlineImageStyle$2() {
        super(0);
    }
