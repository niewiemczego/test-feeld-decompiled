...
final class BrazeFirebaseMessagingService$onNewToken$1 extends Lambda implements Function0<String> {
    final /* synthetic */ String $newToken;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BrazeFirebaseMessagingService$onNewToken$1(String str) {
        super(0);
        this.$newToken = str;
    }
