...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
     ...
     */
    /* JADX WARNING: Missing exception handler attribute for start block: B:40:0x00c9 */
    ...
    public boolean encode(com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r9, java.io.File r10, com.bumptech.glide.load.Options r11) {
        /*
            ...
            long r2 = com.bumptech.glide.util.LogTime.getLogTime()     // Catch:{ all -> 0x00ca }
            com.bumptech.glide.load.Option<java.lang.Integer> r4 = COMPRESSION_QUALITY     // Catch:{ all -> 0x00ca }
            java.lang.Object r4 = r11.get(r4)     // Catch:{ all -> 0x00ca }
            java.lang.Integer r4 = (java.lang.Integer) r4     // Catch:{ all -> 0x00ca }
            int r4 = r4.intValue()     // Catch:{ all -> 0x00ca }
            r5 = 0
            r6 = 0
        ...
        L_0x0069:
            r10 = 2
            boolean r10 = android.util.Log.isLoggable(r0, r10)     // Catch:{ all -> 0x00ca }
            if (r10 == 0) goto L_0x00c0
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ca }
            r10.<init>()     // Catch:{ all -> 0x00ca }
            java.lang.String r4 = "Compressed with type: "
            java.lang.StringBuilder r10 = r10.append(r4)     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            java.lang.String r1 = " of size "
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            int r1 = com.bumptech.glide.util.Util.getBitmapByteSize(r9)     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            java.lang.String r1 = " in "
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            double r1 = com.bumptech.glide.util.LogTime.getElapsedMillis(r2)     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            java.lang.String r1 = ", options format: "
            java.lang.StringBuilder r10 = r10.append(r1)     // Catch:{ all -> 0x00ca }
            com.bumptech.glide.load.Option<android.graphics.Bitmap$CompressFormat> r1 = COMPRESSION_FORMAT     // Catch:{ all -> 0x00ca }
            java.lang.Object r11 = r11.get(r1)     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x00ca }
            java.lang.String r11 = ", hasAlpha: "
            java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ all -> 0x00ca }
            boolean r9 = r9.hasAlpha()     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r9 = r10.append(r9)     // Catch:{ all -> 0x00ca }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x00ca }
            android.util.Log.v(r0, r9)     // Catch:{ all -> 0x00ca }
        L_0x00c0:
