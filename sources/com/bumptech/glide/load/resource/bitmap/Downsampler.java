...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z, int i, int i2, boolean z2, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        if ((options3.inSampleSize == 1 || z5) && shouldUsePool(imageType2)) {
            if (i13 < 0 || i12 < 0 || !z2 || !z5) {
                ...
                if (Log.isLoggable(TAG, 2)) {
                    Log.v(TAG, "Calculated target [" + i6 + ViewHierarchyNode.JsonKeys.X + i5 + "] for source [" + i13 + ViewHierarchyNode.JsonKeys.X + i12 + "], sampleSize: " + i14 + ", targetDensity: " + options3.inTargetDensity + ", density: " + options3.inDensity + ", density multiplier: " + f);
                }
            } else {
                i6 = i3;
                i5 = i10;
        ...
        if (decodeStream != null) {
            ...
            bitmap = TransformationUtils.rotateImageExif(this.bitmapPool, decodeStream, i11);
    ...
    private static void calculateScaling(ImageHeaderParser.ImageType imageType, ImageReader imageReader, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool2, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, BitmapFactory.Options options) throws IOException {
        ...
        BitmapFactory.Options options2 = options;
        if (i12 <= 0 || i13 <= 0) {
            String str = ViewHierarchyNode.JsonKeys.X;
        ...
        if (scaleFactor > 0.0f) {
            ...
            if (sampleSizeRounding != null) {
                ...
                String str2 = ViewHierarchyNode.JsonKeys.X;
                if (i16 > 23 || !NO_DOWNSAMPLE_PRE_N_MIME_TYPES.contains(options2.outMimeType)) {
                ...
                if (Log.isLoggable(TAG, 2)) {
                    String str3 = str2;
                    Log.v(TAG, "Calculate scaling, source: [" + i2 + str3 + i3 + "], degreesToRotate: " + i + ", target: [" + i14 + str3 + i15 + "], power of two scaled: [" + i10 + str3 + i11 + "], exact scale factor: " + scaleFactor + ", power of 2 sample size: " + i9 + ", adjusted scale factor: " + scaleFactor2 + ", target density: " + options2.inTargetDensity + ", density: " + options2.inDensity);
                    return;
                }
                return;
            }
        ...
        String str4 = ViewHierarchyNode.JsonKeys.X;
