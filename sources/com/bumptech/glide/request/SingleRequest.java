...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            r0.throwIfRecycled()
            r0 = 0
            java.lang.Object r1 = r5.requestLock     // Catch:{ all -> 0x00cd }
            monitor-enter(r1)     // Catch:{ all -> 0x00cd }
            r5.loadStatus = r0     // Catch:{ all -> 0x00ca }
            if (r6 != 0) goto L_0x0032
            com.bumptech.glide.load.engine.GlideException r6 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00ca }
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00ca }
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x00ca }
            java.lang.String r8 = " inside, but instead got null."
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x00ca }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x00ca }
            r6.<init>(r7)     // Catch:{ all -> 0x00ca }
            r5.onLoadFailed(r6)     // Catch:{ all -> 0x00ca }
            monitor-exit(r1)     // Catch:{ all -> 0x00ca }
            return
        L_0x0032:
            java.lang.Object r2 = r6.get()     // Catch:{ all -> 0x00ca }
            if (r2 == 0) goto L_0x0066
            java.lang.Class<R> r3 = r5.transcodeClass     // Catch:{ all -> 0x00ca }
            java.lang.Class r4 = r2.getClass()     // Catch:{ all -> 0x00ca }
            boolean r3 = r3.isAssignableFrom(r4)     // Catch:{ all -> 0x00ca }
            if (r3 != 0) goto L_0x0045
            goto L_0x0066
        L_0x0045:
            boolean r3 = r5.canSetResource()     // Catch:{ all -> 0x00ca }
            if (r3 != 0) goto L_0x0061
            r5.resource = r0     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.request.SingleRequest$Status r7 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00c6 }
            r5.status = r7     // Catch:{ all -> 0x00c6 }
            java.lang.String r7 = "GlideRequest"
            int r8 = r5.cookie     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r7, r8)     // Catch:{ all -> 0x00c6 }
        ...
        L_0x0060:
            return
        L_0x0061:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00ca }
            monitor-exit(r1)     // Catch:{ all -> 0x00ca }
            return
        L_0x0066:
            r5.resource = r0     // Catch:{ all -> 0x00c6 }
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00c6 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00c6 }
            r8.<init>()     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = "Expected to receive an object of "
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00c6 }
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = " but instead got "
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
            if (r2 == 0) goto L_0x0088
            java.lang.Class r0 = r2.getClass()     // Catch:{ all -> 0x00c6 }
            goto L_0x008a
        L_0x0088:
            java.lang.String r0 = ""
        L_0x008a:
            ...
            java.lang.String r0 = "{"
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.StringBuilder r8 = r8.append(r2)     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = "} inside Resource{"
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
            java.lang.StringBuilder r8 = r8.append(r6)     // Catch:{ all -> 0x00c6 }
            java.lang.String r0 = "}."
            java.lang.StringBuilder r8 = r8.append(r0)     // Catch:{ all -> 0x00c6 }
        ...
        L_0x00af:
            ...
            r5.onLoadFailed(r7)     // Catch:{ all -> 0x00c6 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c6 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00b4 A[Catch:{ all -> 0x00cc }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x0077:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00cc }
            if (r0 == 0) goto L_0x009d
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00cc }
            r8 = r6
        L_0x0084:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00cc }
            if (r0 == 0) goto L_0x009e
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00cc }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00cc }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00cc }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00cc }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00cc }
            r8 = r8 | r0
            goto L_0x0084
        L_0x009d:
            r8 = r6
        L_0x009e:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00cc }
        ...
        L_0x00b1:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00cc }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00cc }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00cc }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00cc }
        L_0x00bf:
    ...
    private void onLoadFailed(GlideException glideException, int i) {
        ...
        synchronized (this.requestLock) {
            ...
            if (logLevel <= i) {
                Log.w(GLIDE_TAG, "Load failed for " + this.model + " with size [" + this.width + ViewHierarchyNode.JsonKeys.X + this.height + "]", glideException);
                if (logLevel <= 4) {
