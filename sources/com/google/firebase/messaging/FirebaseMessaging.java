...
public class FirebaseMessaging {
    ...
    public /* synthetic */ void m595lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m596lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m597lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m593lambda$getToken$4$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            this.initExecutor.execute(new FirebaseMessaging$$ExternalSyntheticLambda8(this, taskCompletionSource));
            return taskCompletionSource.getTask();
    ...
    public /* synthetic */ void m591lambda$deleteToken$5$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m592lambda$deleteToken$6$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> subscribeToTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$ExternalSyntheticLambda6(str));
    }
    ...
    public /* synthetic */ Task m589lambda$blockingGetToken$10$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token) {
    ...
    public /* synthetic */ Task m590lambda$blockingGetToken$9$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m594lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m594lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    private class AutoInit {
        ...
        public /* synthetic */ void m598lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
