...
class GmsRpc {
    ...
    private final FirebaseApp f29app;
    ...
    public Task<String> getToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f29app), "*", new Bundle()));
    }
    ...
    public Task<?> deleteToken() {
        ...
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f29app), "*", bundle));
    }
    ...
    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance(MessageDigestAlgorithms.SHA_1).digest(this.f29app.getName().getBytes()));
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString(PARAM_GMP_APP_ID, this.f29app.getOptions().getApplicationId());
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), new GmsRpc$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$extractResponseWhenComplete$0$com-google-firebase-messaging-GmsRpc  reason: not valid java name */
    public /* synthetic */ String m599lambda$extractResponseWhenComplete$0$comgooglefirebasemessagingGmsRpc(Task task) throws Exception {
