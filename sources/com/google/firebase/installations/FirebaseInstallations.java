...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(FirebaseApp firebaseApp2, Provider<HeartBeatController> provider, ExecutorService executorService, Executor executor) {
        this(executorService, executor, firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new FirebaseInstallations$$ExternalSyntheticLambda4(firebaseApp2)), new RandomFidGenerator());
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new FirebaseInstallations$$ExternalSyntheticLambda3(this));
        return addGetIdListener;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getId$1$com-google-firebase-installations-FirebaseInstallations  reason: not valid java name */
    public /* synthetic */ void m584lambda$getId$1$comgooglefirebaseinstallationsFirebaseInstallations() {
        m585lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(false);
    }
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new FirebaseInstallations$$ExternalSyntheticLambda1(this));
    }
    ...
    public final void m585lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(boolean z) {
        PersistedInstallationEntry prefsWithGeneratedIdMultiProcessSafe = getPrefsWithGeneratedIdMultiProcessSafe();
        if (z) {
            prefsWithGeneratedIdMultiProcessSafe = prefsWithGeneratedIdMultiProcessSafe.withClearedAuthToken();
        }
        triggerOnStateReached(prefsWithGeneratedIdMultiProcessSafe);
        this.networkExecutor.execute(new FirebaseInstallations$$ExternalSyntheticLambda0(this, z));
    }
    ...
    public void m583lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(boolean r3) {
        /*
            r2 = this;
        ...
        L_0x005f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m583lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(boolean):void");
    }
