...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x011c:
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x0122:
            if (r8 != r1) goto L_0x0131
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            com.google.android.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTextInformationFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x012e:
            r0 = move-exception
            goto L_0x0225
        ...
        L_0x013d:
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeWxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x0143:
            if (r8 != r4) goto L_0x014f
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            com.google.android.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeUrlLinkFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x014f:
            r3 = 73
            r4 = 80
            ...
            com.google.android.exoplayer2.metadata.id3.PrivFrame r1 = decodePrivFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x0165:
            r5 = 71
            r6 = 79
        ...
        L_0x0177:
            com.google.android.exoplayer2.metadata.id3.GeobFrame r1 = decodeGeobFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x017d:
            r5 = 65
            r11 = 67
        ...
        L_0x0192:
            com.google.android.exoplayer2.metadata.id3.ApicFrame r1 = decodeApicFrame(r7, r15, r0)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x0198:
            r3 = 77
        ...
        L_0x01a4:
            com.google.android.exoplayer2.metadata.id3.CommentFrame r1 = decodeCommentFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x01a9:
            ...
            r5 = r22
            r6 = r23
            com.google.android.exoplayer2.metadata.id3.ChapterFrame r1 = decodeChapterFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x01c3:
            ...
            r5 = r22
            r6 = r23
            com.google.android.exoplayer2.metadata.id3.ChapterTocFrame r1 = decodeChapterTOCFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x01db:
            ...
            com.google.android.exoplayer2.metadata.id3.MlltFrame r1 = decodeMlltFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            goto L_0x01f2
        L_0x01ea:
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            com.google.android.exoplayer2.metadata.id3.BinaryFrame r1 = decodeBinaryFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x021c }
        L_0x01f2:
            if (r1 != 0) goto L_0x0218
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ UnsupportedEncodingException -> 0x021c }
            r2.<init>()     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.String r3 = "Failed to decode frame: id="
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.String r0 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.String r2 = ", frameSize="
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.StringBuilder r0 = r0.append(r15)     // Catch:{ UnsupportedEncodingException -> 0x021c }
            java.lang.String r0 = r0.toString()     // Catch:{ UnsupportedEncodingException -> 0x021c }
            com.google.android.exoplayer2.util.Log.w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x021c }
        L_0x0218:
            r7.setPosition(r14)
            return r1
        L_0x021c:
