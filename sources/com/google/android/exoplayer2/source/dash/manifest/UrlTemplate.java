            ...
            if (indexOf == -1) {
                ...
                if (substring.equals(REPRESENTATION)) {
                    ...
                    if (indexOf3 != -1) {
                        ...
                        if (!str2.endsWith(Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE) && !str2.endsWith(ViewHierarchyNode.JsonKeys.X) && !str2.endsWith("X")) {
                            str2 = str2 + Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE;
                        }
