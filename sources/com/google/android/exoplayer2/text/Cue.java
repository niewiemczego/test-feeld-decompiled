...
public final class Cue implements Bundleable {
    ...
    public static final Bundleable.Creator<Cue> CREATOR = new Cue$$ExternalSyntheticLambda0();
    ...
    public Cue(CharSequence charSequence, Layout.Alignment alignment, float f, int i, int i2, float f2, int i3, float f3, int i4, float f4) {
        this(charSequence, alignment, (Layout.Alignment) null, (Bitmap) null, f, i, i2, f2, i3, i4, f4, f3, -3.4028235E38f, false, ViewCompat.MEASURED_STATE_MASK, Integer.MIN_VALUE, 0.0f);
    }
