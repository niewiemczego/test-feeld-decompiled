        ...
        if (isActive(j)) {
            ...
            while (true) {
                ...
                if (this.nodeStartsByRegion.containsKey(str3)) {
                    i = this.nodeStartsByRegion.get(str3).intValue();
                }
                int i2 = i;
                int intValue = ((Integer) next.getValue()).intValue();
                if (i2 != intValue) {
                    applyStyleToOutput(map, (Cue.Builder) Assertions.checkNotNull(map3.get(str3)), i2, intValue, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
                } else {
