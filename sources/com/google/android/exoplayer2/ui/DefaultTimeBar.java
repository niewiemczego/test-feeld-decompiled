...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        if (attributeSet3 != null) {
            Paint paint7 = paint4;
            Paint paint8 = paint5;
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet3, R.styleable.DefaultTimeBar, i, i2);
            try {
        ...
        this.stopScrubbingRunnable = new DefaultTimeBar$$ExternalSyntheticLambda0(this);
        ...
        valueAnimator.addUpdateListener(new DefaultTimeBar$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ void m531lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-android-exoplayer2-ui-DefaultTimeBar  reason: not valid java name */
    public /* synthetic */ void m532lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(ValueAnimator valueAnimator) {
