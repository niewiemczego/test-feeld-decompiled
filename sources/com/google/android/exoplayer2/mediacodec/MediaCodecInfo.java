    ...
    public boolean isVideoSizeAndRateSupportedV21(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i >= i2 || !needsRotatedVerticalResolutionWorkaround(this.name) || !areSizeAndRateSupportedV21(videoCapabilities, i2, i, d)) {
                logNoSupport("sizeAndRate.support, " + i + ViewHierarchyNode.JsonKeys.X + i2 + ViewHierarchyNode.JsonKeys.X + d);
                return false;
            }
            logAssumedSupport("sizeAndRate.rotated, " + i + ViewHierarchyNode.JsonKeys.X + i2 + ViewHierarchyNode.JsonKeys.X + d);
            return true;
        }
    }
