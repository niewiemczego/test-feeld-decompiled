...
interface zzkq {
    ...
    @Deprecated
    void zzC(List list, zzkr zzkr, zzie zzie) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzkr zzkr, zzie zzie) throws IOException;
    ...
    zzgw zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzkr zzkr, zzie zzie) throws IOException;

    void zzu(Object obj, zzkr zzkr, zzie zzie) throws IOException;
