...
final class zzhi implements zzmd {
    ...
    public final void zzd(int i, zzgw zzgw) throws IOException {
        this.zza.zze(i, zzgw);
    }
    ...
    public final void zzq(int i, Object obj, zzkr zzkr) throws IOException {
        zzhh zzhh = this.zza;
        zzhh.zzo(i, 3);
    ...
    public final void zzv(int i, Object obj, zzkr zzkr) throws IOException {
        zzke zzke = (zzke) obj;
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzhh.zzy((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zzhh zzhh = this.zza;
        ...
        while (i2 < list.size()) {
            ...
            zzhh2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzE(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzhh.zzz((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zzhh zzhh = this.zza;
        ...
        while (i2 < list.size()) {
            ...
            zzhh2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
