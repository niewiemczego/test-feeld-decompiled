...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(Context context, int i) {
        zae(context, i, (String) null, getErrorResolutionPendingIntent(context, i, 0, Constants.BRAZE_PUSH_CUSTOM_NOTIFICATION_ID));
    }
    ...
    public final boolean zag(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa(activity, i, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i, Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), 2), onCancelListener);
        if (zaa2 == null) {
            return false;
        }
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), (String) null, zal.zaa(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zal.zaa | C.BUFFER_FLAG_FIRST_SAMPLE));
        return true;
    }

    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), i2), onCancelListener);
    }
    ...
    public Dialog getErrorDialog(Fragment fragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, Constants.BRAZE_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), i2), onCancelListener);
    }
}
