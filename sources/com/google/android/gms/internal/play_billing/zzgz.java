...
class zzgz extends AbstractMap {
    ...
    /* synthetic */ zzgz(int i, zzgy zzgy) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzgx(this, (zzgw) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzgz.zzb()) {
            return entrySet().equals(zzgz.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzgz.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzgz.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgt zzgt = (zzgt) this.zzb.remove(i2 - 1);
            zzm().put(zzgt.zza(), zzgt.getValue());
        }
