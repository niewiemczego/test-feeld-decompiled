...
public final class zzmd {
    ...
    private static zzmg zza(zzmg zzmg, zzmg zzmg2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmg.zza()) {
            return zzmg2;
        }
        if (zzmg2.zza()) {
        ...
        BigInteger mod = zzmg.zzd.multiply(zzmg.zzd).mod(bigInteger2);
        BigInteger mod2 = zzmg2.zzd.multiply(zzmg2.zzd).mod(bigInteger2);
        BigInteger mod3 = zzmg.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmg2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmg.zzc.multiply(zzmg2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmg2.zzc.multiply(zzmg.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (!mod3.equals(mod4)) {
            ...
            BigInteger add = zzmg.zzd.add(zzmg2.zzd);
            return new zzmg(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
        } else if (!mod5.equals(mod6)) {
            return zzmg.zza;
        } else {
            return zza(zzmg, bigInteger, bigInteger2);
        }
    }

    private static zzmg zza(zzmg zzmg, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmg.zzc.equals(BigInteger.ZERO)) {
            return zzmg.zza;
        }
        BigInteger mod = zzmg.zzb.multiply(zzmg.zzb).mod(bigInteger2);
        BigInteger mod2 = zzmg.zzc.multiply(zzmg.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmg.zzd.multiply(zzmg.zzd).mod(bigInteger2);
        BigInteger add = zzmg.zzb.add(mod2);
        ...
        BigInteger add3 = zzmg.zzc.add(zzmg.zzd);
        return new zzmg(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    private static zzmg zza(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zzmg.zza;
        }
        BigInteger mod = new BigInteger(1, zzov.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzmg(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        if (!(zza(eCParameterSpec, zza) || zza(eCParameterSpec, zzb) || zza(eCParameterSpec, zzc))) {
            ...
            zzmg zza3 = zza(ECPoint.POINT_INFINITY, zza2);
            zzmg zza4 = zza(generator, zza2);
            for (int bitLength = bigInteger.bitLength(); bitLength >= 0; bitLength--) {
                if (bigInteger.testBit(bitLength)) {
                    zza3 = zza(zza3, zza4, a, zza2);
                    zza4 = zza(zza4, a, zza2);
                } else {
                    zza4 = zza(zza3, zza4, a, zza2);
                    zza3 = zza(zza3, a, zza2);
                }
            }
            if (zza3.zza()) {
