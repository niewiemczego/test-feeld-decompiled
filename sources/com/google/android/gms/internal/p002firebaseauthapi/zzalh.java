...
class zzalh<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    static <FieldDescriptorType extends zzaiu<FieldDescriptorType>> zzalh<FieldDescriptorType, Object> zza(int i) {
        return new zzalg(i);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzalo remove = this.zzb.remove(i2 - 1);
            zzf().put((Comparable) remove.getKey(), remove.getValue());
        }
        this.zzb.add(i, new zzalo(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzalo(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzalh.zzb()) {
            return entrySet().equals(zzalh.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzb(i).equals(zzalh.zzb(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzalh.zzc);
        }
        return true;
    }
