...
public final class zzach {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0051, code lost:
        return new com.google.firebase.auth.FirebaseAuthWebException(zza(r0), r1);
     */
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzyi zzyi, FirebaseUser firebaseUser) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzyi);
        Pair pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.zza(zzyi, firebaseAuth, firebaseUser));
    }
    ...
    private static String zza(String str, Status status) {
        ...
        return String.format(str + " [ %s ]", new Object[]{status.getStatusMessage()});
    }
