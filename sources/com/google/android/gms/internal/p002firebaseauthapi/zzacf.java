...
public class zzacf {
    ...
    public zzacf(zzacc zzacc, Logger logger) {
        this.zza = (zzacc) Preconditions.checkNotNull(zzacc);
    ...
    public final void zza(zzafm zzafm, zzafb zzafb) {
        try {
            this.zza.zza(zzafm, zzafb);
        } catch (RemoteException e) {
