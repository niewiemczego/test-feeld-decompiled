...
final class zzaiy extends zzahg<Float> implements zzajg<Float>, zzakw, RandomAccess {
    ...
    public final /* synthetic */ zzajg zza(int i) {
        if (i >= this.zzc) {
            return new zzaiy(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzaiy(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzaiy.zzb, 0, this.zzb, this.zzc, zzaiy.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzaiy.zzc) {
            return false;
        }
        float[] fArr = zzaiy.zzb;
