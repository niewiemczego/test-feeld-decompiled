...
interface zzanb {
    ...
    void zza(int i, zzahm zzahm) throws IOException;

    <K, V> void zza(int i, zzakf<K, V> zzakf, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzalc zzalc) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzahm> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzalc zzalc) throws IOException;
    ...
    void zzb(int i, Object obj, zzalc zzalc) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzalc zzalc) throws IOException;
