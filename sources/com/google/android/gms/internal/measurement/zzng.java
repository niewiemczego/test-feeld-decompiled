...
public final class zzng implements zznh {
    ...
    static {
        ...
        zzd = zza2.zza("measurement.config.cache_time", (long) DateUtils.MILLIS_PER_DAY);
        ...
        zzs = zza2.zza("measurement.monitoring.sample_period_millis", (long) DateUtils.MILLIS_PER_DAY);
        zzt = zza2.zza("measurement.rb.attribution.app_allowlist", "");
        zzu = zza2.zza("measurement.upload.realtime_upload_interval", 10000);
        zzv = zza2.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000);
        zzw = zza2.zza("measurement.config.cache_time.service", (long) DateUtils.MILLIS_PER_HOUR);
        zzx = zza2.zza("measurement.service_client.idle_disconnect_millis", 5000);
        zzy = zza2.zza("measurement.log_tag.service", "FA-SVC");
        zzz = zza2.zza("measurement.upload.stale_data_deletion_interval", (long) DateUtils.MILLIS_PER_DAY);
        ...
        zzah = zza2.zza("measurement.upload.initial_upload_delay_time", (long) C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        zzai = zza2.zza("measurement.upload.interval", (long) DateUtils.MILLIS_PER_HOUR);
        zzaj = zza2.zza("measurement.upload.max_bundle_size", (long) PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzas = zza2.zza("measurement.upload.max_batch_size", (long) PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzaw = zza2.zza("measurement.upload.window_interval", (long) DateUtils.MILLIS_PER_HOUR);
