...
interface zzmw {
    ...
    void zza(int i, zzhm zzhm) throws IOException;

    <K, V> void zza(int i, zzke<K, V> zzke, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzlb zzlb) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzhm> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzlb zzlb) throws IOException;
    ...
    void zzb(int i, Object obj, zzlb zzlb) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzlb zzlb) throws IOException;
