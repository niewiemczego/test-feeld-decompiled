        ...
        switch (zzbs.zza[zzg.zza(str).ordinal()]) {
            ...
            case 2:
                ...
                if (list.size() % 2 == 0) {
                    ...
                    while (i2 < list.size() - 1) {
                        zzaq zza3 = zzh.zza(list.get(i2));
                        if (zza3 instanceof zzas) {
                            zzh.zzb(zza3.zzf(), zzh.zza(list.get(i2 + 1)));
                            i2 += 2;
                        } else {
            ...
            case 4:
                ...
                if (list.size() % 2 == 0) {
                    zzap zzap = new zzap();
                    while (i < list.size() - 1) {
                        zzaq zza6 = zzh.zza(list.get(i));
                        zzaq zza7 = zzh.zza(list.get(i + 1));
