...
public final class zzcb {
    ...
    public static java.lang.String zza(android.content.ContentResolver r11, java.lang.String r12, java.lang.String r13) {
        /*
            ...
            monitor-enter(r13)
            java.util.HashMap r0 = zze     // Catch:{ all -> 0x00ab }
            r1 = 1
            r2 = 0
            r3 = 0
            ...
            com.google.android.gms.internal.auth.zzca r4 = new com.google.android.gms.internal.auth.zzca     // Catch:{ all -> 0x00ab }
        ...
        L_0x002a:
            ...
            java.util.HashMap r0 = zzf     // Catch:{ all -> 0x00ab }
            r0.clear()     // Catch:{ all -> 0x00ab }
            java.util.HashMap r0 = zzg     // Catch:{ all -> 0x00ab }
            r0.clear()     // Catch:{ all -> 0x00ab }
            java.util.HashMap r0 = zzh     // Catch:{ all -> 0x00ab }
            r0.clear()     // Catch:{ all -> 0x00ab }
            java.util.HashMap r0 = zzi     // Catch:{ all -> 0x00ab }
            r0.clear()     // Catch:{ all -> 0x00ab }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00ab }
            r0.<init>()     // Catch:{ all -> 0x00ab }
            zzl = r0     // Catch:{ all -> 0x00ab }
        ...
        L_0x0054:
            ...
            java.util.HashMap r4 = zze     // Catch:{ all -> 0x00ab }
            boolean r4 = r4.containsKey(r12)     // Catch:{ all -> 0x00ab }
            if (r4 == 0) goto L_0x006c
            java.util.HashMap r11 = zze     // Catch:{ all -> 0x00ab }
