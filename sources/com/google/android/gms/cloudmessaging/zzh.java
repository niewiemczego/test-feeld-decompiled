...
public final /* synthetic */ class zzh implements Runnable {
    ...
    public final void run() {
        /*
            r8 = this;
        L_0x0000:
            com.google.android.gms.cloudmessaging.zzn r0 = r8.zza
            monitor-enter(r0)
        ...
        L_0x0017:
            ...
            com.google.android.gms.cloudmessaging.zzr r1 = (com.google.android.gms.cloudmessaging.zzr) r1     // Catch:{ all -> 0x009d }
            android.util.SparseArray r3 = r0.zze     // Catch:{ all -> 0x009d }
            int r4 = r1.zza     // Catch:{ all -> 0x009d }
            r3.put(r4, r1)     // Catch:{ all -> 0x009d }
            com.google.android.gms.cloudmessaging.zzu r3 = r0.zzf     // Catch:{ all -> 0x009d }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzc     // Catch:{ all -> 0x009d }
            com.google.android.gms.cloudmessaging.zzl r4 = new com.google.android.gms.cloudmessaging.zzl     // Catch:{ all -> 0x009d }
            r4.<init>(r0, r1)     // Catch:{ all -> 0x009d }
            r5 = 30
            java.util.concurrent.TimeUnit r7 = java.util.concurrent.TimeUnit.SECONDS     // Catch:{ all -> 0x009d }
            r3.schedule(r4, r5, r7)     // Catch:{ all -> 0x009d }
            monitor-exit(r0)     // Catch:{ all -> 0x009d }
        ...
        L_0x0055:
            com.google.android.gms.cloudmessaging.zzu r3 = r0.zzf
            ...
            r4.putBundle(r3, r1)
            r6.setData(r4)
            com.google.android.gms.cloudmessaging.zzp r1 = r0.zzc     // Catch:{ RemoteException -> 0x0093 }
