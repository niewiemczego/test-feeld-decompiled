...
public class InstanceID {
    ...
    public final void zzd(String str, String str2, Bundle bundle) throws IOException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            ...
            bundle.putString(Bayeux.KEY_SUBSCRIPTION, str);
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            ...
            if (!zzbu.get().booleanValue() || !zze.contains(CertificateUtil.DELIMITER) || zze.startsWith(String.valueOf(getId()).concat(CertificateUtil.DELIMITER))) {
                if (zze != null) {
