...
public class zzaf {
    ...
    private final android.os.Bundle zzk(android.os.Bundle r9) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r8.zzcz     // Catch:{ all -> 0x01ea }
            r3.put(r1, r0)     // Catch:{ all -> 0x01ea }
        ...
        L_0x00e7:
            ...
            r3.obj = r2
            android.os.Messenger r5 = r8.zzda     // Catch:{ RemoteException -> 0x00ff }
            r5.send(r3)     // Catch:{ RemoteException -> 0x00ff }
            goto L_0x018d
        L_0x00ff:
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)
        ...
        L_0x010e:
            ...
            monitor-enter(r9)
            android.content.BroadcastReceiver r3 = zzcy     // Catch:{ all -> 0x014e }
            if (r3 != 0) goto L_0x0147
            com.google.android.gms.iid.zzah r3 = new com.google.android.gms.iid.zzah     // Catch:{ all -> 0x014e }
            r3.<init>(r8)     // Catch:{ all -> 0x014e }
            zzcy = r3     // Catch:{ all -> 0x014e }
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)     // Catch:{ all -> 0x014e }
            if (r3 == 0) goto L_0x012d
            java.lang.String r3 = "InstanceID"
            java.lang.String r4 = "Registered GSF callback receiver"
            android.util.Log.d(r3, r4)     // Catch:{ all -> 0x014e }
        L_0x012d:
            android.content.IntentFilter r3 = new android.content.IntentFilter     // Catch:{ all -> 0x014e }
            java.lang.String r4 = "com.google.android.c2dm.intent.REGISTRATION"
            r3.<init>(r4)     // Catch:{ all -> 0x014e }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x014e }
            java.lang.String r4 = r4.getPackageName()     // Catch:{ all -> 0x014e }
            r3.addCategory(r4)     // Catch:{ all -> 0x014e }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x014e }
            android.content.BroadcastReceiver r5 = zzcy     // Catch:{ all -> 0x014e }
            java.lang.String r6 = "com.google.android.c2dm.permission.SEND"
            r7 = 0
            r4.registerReceiver(r5, r3, r6, r7)     // Catch:{ all -> 0x014e }
        L_0x0147:
        ...
        L_0x0151:
            ...
            r9.obj = r2
            com.google.android.gms.iid.MessengerCompat r3 = r8.zzdb     // Catch:{ RemoteException -> 0x016f }
            r3.send(r9)     // Catch:{ RemoteException -> 0x016f }
            goto L_0x018d
        L_0x016f:
        ...
        L_0x018d:
            ...
            monitor-enter(r9)
            java.util.Map<java.lang.String, java.lang.Object> r0 = r8.zzcz     // Catch:{ all -> 0x01df }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x01df }
            boolean r1 = r0 instanceof android.os.Bundle     // Catch:{ all -> 0x01df }
            if (r1 == 0) goto L_0x01a5
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ all -> 0x01df }
            monitor-exit(r9)     // Catch:{ all -> 0x01df }
            return r0
        L_0x01a5:
            boolean r1 = r0 instanceof java.lang.String     // Catch:{ all -> 0x01df }
            if (r1 == 0) goto L_0x01b1
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x01df }
        ...
        L_0x01b1:
            ...
            java.lang.String r0 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01df }
            java.lang.String r2 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01df }
            int r2 = r2.length()     // Catch:{ all -> 0x01df }
            int r2 = r2 + 12
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x01df }
            r3.<init>(r2)     // Catch:{ all -> 0x01df }
            java.lang.String r2 = "No response "
            java.lang.StringBuilder r2 = r3.append(r2)     // Catch:{ all -> 0x01df }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ all -> 0x01df }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x01df }
            android.util.Log.w(r1, r0)     // Catch:{ all -> 0x01df }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x01df }
