...
public final class Stats implements Serializable {
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper((Object) this).add(MetricSummary.JsonKeys.COUNT, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add(MetricSummary.JsonKeys.MIN, this.min).add(MetricSummary.JsonKeys.MAX, this.max).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add(MetricSummary.JsonKeys.COUNT, this.count).toString();
    }
