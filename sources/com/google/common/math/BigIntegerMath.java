...
public final class BigIntegerMath {
    ...
    public static int log10(BigInteger bigInteger, RoundingMode roundingMode) {
        int i;
        MathPreconditions.checkPositive(ViewHierarchyNode.JsonKeys.X, bigInteger);
    ...
    public static BigInteger factorial(int i) {
        int i2 = i;
        MathPreconditions.checkNonNegative(Constants.BRAZE_PUSH_CUSTOM_NOTIFICATION_ID, i2);
    ...
    public static BigInteger binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(Constants.BRAZE_PUSH_CUSTOM_NOTIFICATION_ID, i);
