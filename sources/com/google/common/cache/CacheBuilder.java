...
public final class CacheBuilder<K, V> {
    ...
    public String toString() {
        ...
        if (j3 != -1) {
            stringHelper.add("expireAfterWrite", (Object) new StringBuilder(22).append(j3).append("ns").toString());
        }
        long j4 = this.expireAfterAccessNanos;
        if (j4 != -1) {
            stringHelper.add("expireAfterAccess", (Object) new StringBuilder(22).append(j4).append("ns").toString());
        }
