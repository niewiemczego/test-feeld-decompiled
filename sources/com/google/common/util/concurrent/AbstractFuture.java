    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        if (listenableFuture instanceof Trusted) {
            ...
            try {
                ...
                return new Cancellation(false, new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf2).length() + 84).append("get() did not throw CancellationException, despite reporting isCancelled() == true: ").append(valueOf2).toString(), e));
            } catch (CancellationException e2) {
                if (isCancelled) {
                    return new Cancellation(false, e2);
                }
                String valueOf3 = String.valueOf(listenableFuture);
                return new Failure(new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf3).length() + 77).append("get() threw CancellationException, despite reporting isCancelled() == false: ").append(valueOf3).toString(), e2));
            } catch (Throwable th) {
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            try {
                ...
                str = new StringBuilder(String.valueOf(valueOf).length() + 38).append("Exception thrown from implementation: ").append(valueOf).toString();
            }
            if (str != null) {
