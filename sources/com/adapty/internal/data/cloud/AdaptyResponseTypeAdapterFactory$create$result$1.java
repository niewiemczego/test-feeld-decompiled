...
public final class AdaptyResponseTypeAdapterFactory$create$result$1 extends TypeAdapter<TYPE> {
    ...
    AdaptyResponseTypeAdapterFactory$create$result$1(AdaptyResponseTypeAdapterFactory<TYPE> adaptyResponseTypeAdapterFactory, TypeAdapter<TYPE> typeAdapter, TypeAdapter<JsonElement> typeAdapter2) {
        this.this$0 = adaptyResponseTypeAdapterFactory;
    ...
    public TYPE read(JsonReader jsonReader) {
        ...
        return adaptyResponseTypeAdapterFactory.read(jsonReader, typeAdapter, typeAdapter2);
    }
}
