...
public final class AdaptyViewConfigShapeTypeTypeAdapterFactory extends AdaptyViewConfigBaseTypeAdapterFactory<AdaptyViewConfiguration.Component.Shape.Type> {
    ...
    @Deprecated
    public static final List<String> orderedClassValues = CollectionsKt.listOf("Circle", "RectWithArc", "Rectangle");

    public AdaptyViewConfigShapeTypeTypeAdapterFactory() {
        super(AdaptyViewConfiguration.Component.Shape.Type.class);
    }

    public List<TypeAdapter<? extends AdaptyViewConfiguration.Component.Shape.Type>> createOrderedChildAdapters(Gson gson) {
        Intrinsics.checkNotNullParameter(gson, "gson");
        TypeAdapterFactory typeAdapterFactory = this;
        return CollectionsKt.listOf(gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Component.Shape.Type.Circle.class)), gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Component.Shape.Type.RectWithArc.class)), gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Component.Shape.Type.Rectangle.class)));
    }

    public Pair<JsonElement, String> createJsonElementWithClassValueOnWrite(AdaptyViewConfiguration.Component.Shape.Type type, List<? extends TypeAdapter<? extends AdaptyViewConfiguration.Component.Shape.Type>> list) {
        ...
        if (type instanceof AdaptyViewConfiguration.Component.Shape.Type.Circle) {
            return TuplesKt.to(getFor(list, 0).toJsonTree(type), orderedClassValues.get(0));
        }
        if (type instanceof AdaptyViewConfiguration.Component.Shape.Type.RectWithArc) {
            return TuplesKt.to(getFor(list, 1).toJsonTree(type), orderedClassValues.get(1));
        }
        if (type instanceof AdaptyViewConfiguration.Component.Shape.Type.Rectangle) {
            return TuplesKt.to(getFor(list, 2).toJsonTree(type), orderedClassValues.get(2));
        }
        throw new NoWhenBranchMatchedException();
    }

    public AdaptyViewConfiguration.Component.Shape.Type createResultOnRead(JsonObject jsonObject, String str, List<? extends TypeAdapter<? extends AdaptyViewConfiguration.Component.Shape.Type>> list) {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/adapty/internal/crossplatform/AdaptyViewConfigShapeTypeTypeAdapterFactory$Companion;", "", "()V", "orderedClassValues", "", "", "getOrderedClassValues", "()Ljava/util/List;", "crossplatform_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: AdaptyViewConfigShapeTypeTypeAdapterFactory.kt */
