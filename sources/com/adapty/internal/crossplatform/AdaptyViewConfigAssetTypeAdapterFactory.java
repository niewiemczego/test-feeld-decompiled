...
public final class AdaptyViewConfigAssetTypeAdapterFactory extends AdaptyViewConfigBaseTypeAdapterFactory<AdaptyViewConfiguration.Asset> {
    ...
    @Deprecated
    public static final List<String> orderedClassValues = CollectionsKt.listOf("Color", "Font", "Gradient", "Image");

    public AdaptyViewConfigAssetTypeAdapterFactory() {
        super(AdaptyViewConfiguration.Asset.class);
    }

    public List<TypeAdapter<? extends AdaptyViewConfiguration.Asset>> createOrderedChildAdapters(Gson gson) {
        Intrinsics.checkNotNullParameter(gson, "gson");
        TypeAdapterFactory typeAdapterFactory = this;
        return CollectionsKt.listOf(gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Asset.Color.class)), gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Asset.Font.class)), gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Asset.Gradient.class)), gson.getDelegateAdapter(typeAdapterFactory, TypeToken.get(AdaptyViewConfiguration.Asset.Image.class)));
    }

    public Pair<JsonElement, String> createJsonElementWithClassValueOnWrite(AdaptyViewConfiguration.Asset asset, List<? extends TypeAdapter<? extends AdaptyViewConfiguration.Asset>> list) {
        ...
        if (asset instanceof AdaptyViewConfiguration.Asset.Color) {
            JsonElement jsonTree = getFor(list, 0).toJsonTree(asset);
        ...
        } else if (asset instanceof AdaptyViewConfiguration.Asset.Font) {
            JsonElement jsonTree2 = getFor(list, 1).toJsonTree(asset);
        ...
        } else if (asset instanceof AdaptyViewConfiguration.Asset.Gradient) {
            JsonElement jsonTree3 = getFor(list, 2).toJsonTree(asset);
        ...
        } else if (asset instanceof AdaptyViewConfiguration.Asset.Image) {
            JsonElement jsonTree4 = getFor(list, 3).toJsonTree(asset);
    ...
    public AdaptyViewConfiguration.Asset createResultOnRead(JsonObject jsonObject, String str, List<? extends TypeAdapter<? extends AdaptyViewConfiguration.Asset>> list) {
        ...
        if (typeAdapter != null) {
            return (AdaptyViewConfiguration.Asset) typeAdapter.fromJsonTree(jsonObject);
        }
        return null;
    }

    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lcom/adapty/internal/crossplatform/AdaptyViewConfigAssetTypeAdapterFactory$Companion;", "", "()V", "orderedClassValues", "", "", "getOrderedClassValues", "()Ljava/util/List;", "crossplatform_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: AdaptyViewConfigAssetTypeAdapterFactory.kt */
