...
public class CrossPromotionHelper {
    ...
    public static void logAndOpenStore(Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator AFInAppEventParameterName = AFInAppEventParameterName(context, str, str2, map, String.format(AFf1dSDK.AFKeystoreWrapper, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1xSDK.AFInAppEventType().getHostName()}));
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            AFInAppEventParameterName(AFInAppEventParameterName.generateLink(), context, new AFe1oSDK(context));
        }
    }
    ...
    public static void logCrossPromoteImpression(Context context, String str, String str2, Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            AFInAppEventParameterName(AFInAppEventParameterName(context, str, str2, map, String.format(AFKeystoreWrapper, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1xSDK.AFInAppEventType().getHostName()})).generateLink(), context, (AFe1oSDK) null);
        }
    }

    private static void AFInAppEventParameterName(String str, Context context, AFe1oSDK aFe1oSDK) {
        AFb1xSDK AFInAppEventType = AFb1xSDK.AFInAppEventType();
        AFInAppEventType.AFInAppEventType(context);
        AFc1vSDK AFKeystoreWrapper2 = AFInAppEventType.AFKeystoreWrapper();
        AFd1jSDK aFd1jSDK = new AFd1jSDK(AFKeystoreWrapper2, str, aFe1oSDK);
        AFd1pSDK afDebugLog = AFKeystoreWrapper2.afDebugLog();
        afDebugLog.AFKeystoreWrapper.execute(new Runnable(aFd1jSDK) {
...
*/
    ...
    private static LinkGenerator AFInAppEventParameterName(Context context, String str, String str2, Map<String, String> map, String str3) {
        ...
        if (string != null) {
            linkGenerator.addParameter(AndroidContextProvider.SETTING_ADVERTISING_ID, string);
        }
    ...
    public static void setUrl(Map<String, String> map) {
        for (Map.Entry next : map.entrySet()) {
            ...
            } else if (str2.equals(App.TYPE)) {
                c = 0;
            }
            if (c == 0) {
                AFf1dSDK.AFKeystoreWrapper = str;
            } else if (c == 1) {
