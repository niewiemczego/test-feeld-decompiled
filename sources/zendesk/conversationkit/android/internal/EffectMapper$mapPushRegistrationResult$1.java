...
final class EffectMapper$mapPushRegistrationResult$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.PushTokenUpdateResult $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapPushRegistrationResult$1(Effect.PushTokenUpdateResult pushTokenUpdateResult) {
        super(1);
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        final Effect.PushTokenUpdateResult pushTokenUpdateResult = this.$effect;
