...
final class EffectMapper$mapPushRegistrationPending$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.PushTokenPrepared $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapPushRegistrationPending$1(Effect.PushTokenPrepared pushTokenPrepared) {
        super(1);
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        final Effect.PushTokenPrepared pushTokenPrepared = this.$effect;
