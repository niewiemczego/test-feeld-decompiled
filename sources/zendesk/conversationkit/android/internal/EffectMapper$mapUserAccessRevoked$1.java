...
final class EffectMapper$mapUserAccessRevoked$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.UserAccessRevoked $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapUserAccessRevoked$1(Effect.UserAccessRevoked userAccessRevoked) {
        super(1);
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        if (this.$effect.getResult() instanceof ConversationKitResult.Failure) {
            final Effect.UserAccessRevoked userAccessRevoked = this.$effect;
