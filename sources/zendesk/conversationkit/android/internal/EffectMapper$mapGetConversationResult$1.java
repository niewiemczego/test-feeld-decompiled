...
final class EffectMapper$mapGetConversationResult$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.GetConversationResult $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapGetConversationResult$1(Effect.GetConversationResult getConversationResult) {
        super(1);
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        if (this.$effect.getResult() instanceof ConversationKitResult.Success) {
            final Effect.GetConversationResult getConversationResult = this.$effect;
