...
final class EffectMapper$mapCreateConversationResult$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.CreateConversationResult $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapCreateConversationResult$1(Effect.CreateConversationResult createConversationResult) {
        super(1);
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        if (this.$effect.getResult() instanceof ConversationKitResult.Success) {
            final Effect.CreateConversationResult createConversationResult = this.$effect;
