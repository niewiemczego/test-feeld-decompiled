...
final class ConversationKitStore$removeEventListener$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ ConversationKitEventListener $listener;
    int label;
    final /* synthetic */ ConversationKitStore this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConversationKitStore$removeEventListener$1(ConversationKitStore conversationKitStore, ConversationKitEventListener conversationKitEventListener, Continuation<? super ConversationKitStore$removeEventListener$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ConversationKitStore$removeEventListener$1(this.this$0, this.$listener, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ConversationKitStore$removeEventListener$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                conversationKitStore.listeners.remove(conversationKitEventListener);
