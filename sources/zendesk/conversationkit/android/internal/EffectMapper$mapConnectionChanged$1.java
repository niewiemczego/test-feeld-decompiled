...
final class EffectMapper$mapConnectionChanged$1 extends Lambda implements Function1<EventReceiver, Unit> {
    final /* synthetic */ Effect.ConnectionChanged $effect;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EffectMapper$mapConnectionChanged$1(Effect.ConnectionChanged connectionChanged) {
        super(1);
        this.$effect = connectionChanged;
    }
    ...
    public final void invoke(EventReceiver eventReceiver) {
        ...
        final Effect.ConnectionChanged connectionChanged = this.$effect;
