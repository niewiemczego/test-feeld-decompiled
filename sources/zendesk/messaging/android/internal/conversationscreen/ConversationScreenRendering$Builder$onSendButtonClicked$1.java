...
final class ConversationScreenRendering$Builder$onSendButtonClicked$1 extends Lambda implements Function1<String, Unit> {
    ...
    ConversationScreenRendering$Builder$onSendButtonClicked$1() {
        super(1);
    }
