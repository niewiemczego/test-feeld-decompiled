...
final class MessageLogCellFactory$createFileUploadCell$1$1 extends Lambda implements Function1<FileRendering, FileRendering> {
    ...
    MessageLogCellFactory$createFileUploadCell$1$1(Integer num, FileView fileView, MessageLogEntry.MessageContainer messageContainer, MessageContent.FileUpload fileUpload, Function1<? super MessageLogEntry.MessageContainer, Unit> function1) {
        super(1);
    ...
    public final FileRendering invoke(FileRendering fileRendering) {
        ...
        if (this.$item.getDirection() == MessageDirection.INBOUND) {
            ...
            adjustAlpha$zendesk_messaging_messaging_android$default = ContextCompat.getColor(this.$this_apply.getContext(), R.color.zma_color_on_danger);
        ...
        final MessageContent.FileUpload fileUpload = this.$uploadContent;
            ...
            public final FileState invoke(FileState fileState) {
                ...
                if (messageContainer.getDirection() == MessageDirection.INBOUND) {
                    ...
                    if (i2 == 1) {
                        ...
                        i = ContextCompat.getColor(fileView.getContext(), R.color.zma_color_danger);
                    } else {
                        throw new NoWhenBranchMatchedException();
                    }
                }
                return fileState.copy(name, size, valueOf, valueOf2, Integer.valueOf(i), Integer.valueOf(MessageLogCellFactory.INSTANCE.getCellDrawable(messageContainer.getShape(), messageContainer.getDirection())));
            }
        });
