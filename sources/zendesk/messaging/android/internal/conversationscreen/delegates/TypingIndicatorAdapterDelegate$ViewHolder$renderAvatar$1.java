...
final class TypingIndicatorAdapterDelegate$ViewHolder$renderAvatar$1 extends Lambda implements Function1<AvatarImageRendering, AvatarImageRendering> {
    final /* synthetic */ String $avatarUrl;
    final /* synthetic */ TypingIndicatorAdapterDelegate.ViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TypingIndicatorAdapterDelegate$ViewHolder$renderAvatar$1(String str, TypingIndicatorAdapterDelegate.ViewHolder viewHolder) {
        super(1);
        this.$avatarUrl = str;
    ...
    public final AvatarImageRendering invoke(AvatarImageRendering avatarImageRendering) {
        ...
        final TypingIndicatorAdapterDelegate.ViewHolder viewHolder = this.this$0;
