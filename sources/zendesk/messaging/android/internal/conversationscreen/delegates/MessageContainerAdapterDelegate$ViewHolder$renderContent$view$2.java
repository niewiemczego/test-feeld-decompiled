...
final class MessageContainerAdapterDelegate$ViewHolder$renderContent$view$2 extends Lambda implements Function1<List<? extends Field>, Unit> {
    ...
    MessageContainerAdapterDelegate$ViewHolder$renderContent$view$2(Function2<? super List<? extends Field>, ? super MessageLogEntry.MessageContainer, Unit> function2, MessageLogEntry.MessageContainer messageContainer) {
        super(1);
