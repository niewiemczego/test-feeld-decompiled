...
final class MessageContainerAdapterDelegate$ViewHolder$renderContent$view$4 extends Lambda implements Function1<List<? extends Field>, Unit> {
    ...
    MessageContainerAdapterDelegate$ViewHolder$renderContent$view$4(Function2<? super List<? extends Field>, ? super MessageLogEntry.MessageContainer, Unit> function2, MessageLogEntry.MessageContainer messageContainer) {
        super(1);
