...
final class MessageContainerAdapterDelegate$ViewHolder$adjustDirectionAndWidth$2 extends Lambda implements Function1<LinearLayout.LayoutParams, Unit> {
    ...
    MessageContainerAdapterDelegate$ViewHolder$adjustDirectionAndWidth$2(MessageDirection messageDirection, int i, int i2, int i3) {
        super(1);
