...
final class MessageReceiptView$buildLabelAndIconViews$2 extends Lambda implements Function1<LinearLayout, Unit> {
    final /* synthetic */ MessageReceiptView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MessageReceiptView$buildLabelAndIconViews$2(MessageReceiptView messageReceiptView) {
        super(1);
