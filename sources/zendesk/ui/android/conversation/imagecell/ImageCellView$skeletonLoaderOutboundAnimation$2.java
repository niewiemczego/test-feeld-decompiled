...
final class ImageCellView$skeletonLoaderOutboundAnimation$2 extends Lambda implements Function0<AnimatedVectorDrawableCompat> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ImageCellView$skeletonLoaderOutboundAnimation$2(Context context) {
        super(0);
