...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\n¢\u0006\u0002\b\u0005"}, d2 = {"<anonymous>", "", "T", "textState", "Lzendesk/ui/android/conversation/form/FieldState$Text;", "invoke"}, k = 3, mv = {1, 6, 0}, xi = 48)
/* compiled from: FormView.kt */
final class FormViewKt$withStateChangedInterceptor$1 extends Lambda implements Function1<FieldState.Text, Unit> {
    ...
    FormViewKt$withStateChangedInterceptor$1(Function1<? super T, Unit> function1, FieldRendering<T> fieldRendering, Function1<? super DisplayedField, Unit> function12, int i) {
        super(1);
    ...
    public final void invoke(FieldState.Text text) {
        Intrinsics.checkNotNullParameter(text, "textState");
        ...
        this.$onFormDisplayedFieldsChanged.invoke(new DisplayedField(this.$currentIndex, text.getText()));
    }
}
