...
final class FormViewKt$withStateFocusChanged$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ Function1<Boolean, Unit> $onFieldFocusChanged;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FormViewKt$withStateFocusChanged$1(Function1<? super Boolean, Unit> function1) {
        super(1);
